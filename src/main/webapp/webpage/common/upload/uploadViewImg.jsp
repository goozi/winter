...
<script type="text/javascript">
        ...
        function uploadCallback(callback,inputId){
          ...
          var extend= $("#fileExtend").val();
                callback(url,key,name,extend,inputId);
  ...
  <input id="fileName" type="hidden"/>
   ...
   <tbody>
    <tr>
     ...
     <td class="value">
      <t:upload name="instruction" dialog="false" multi="false" extend="*.jpg;*.jpeg;*.png;*.gif;*.bmp;*.ico;*.tif;" queueID="instructionfile" view="false" auto="true" uploader="systemController.do?saveFiles" onUploadSuccess="uploadSuccess"  id="instruction" formData="documentTitle"></t:upload>
     </td>
    </tr>
    <tr>
