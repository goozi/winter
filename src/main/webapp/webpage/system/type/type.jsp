...
<t:formvalid formid="formobj" layout="div" dialog="true" action="systemController.do?saveType" windowType="dialog">
    <input name="id" type="hidden" value="${type.id }">
    <input name="TSTypegroup.id" type="hidden" value="${typegroupid}">
    <fieldset class="step">
        <%--// add-start--Author:Zerrion  Date:20140928 for：添加显示字段--%>
        <div class="form">
        ...
        <%--// add-end--Author:Zerrion  Date:20140928 for：添加显示字段--%>
        ...
        <div class="form">
            ...
            <div class="form">
                ...
                <input name="typename" class="inputxt" value="${type.typename }" datatype="s1-100" style="width: 300px">
