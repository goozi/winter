...
<t:datagrid name="roleUserList" title="common.operation"
	...
	<t:dgToolBar title="common.add.param" langArg="common.user" icon="icon-add" url="userController.do?addorupdate&roleId=${roleId}" funname="add" windowType="dialog" operationCode="userAddBtnHide"></t:dgToolBar>
	<t:dgToolBar title="common.edit.param" langArg="common.user" icon="icon-edit" url="userController.do?addorupdate&roleId=${roleId}" funname="update"  windowType="dialog"></t:dgToolBar>
	<t:dgToolBar title="common.add.exist.user" icon="icon-add" url="roleController.do?goAddUserToRole&roleId=${roleId}" funname="add" width="500"  windowType="dialog"></t:dgToolBar>
</t:datagrid>
