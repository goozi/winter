...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="tSTreeinfoController.do?doUpdate">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="treeName" name="treeName" type="text" style="width: 150px" class="inputxt"  datatype="*1-30" value='${tSTreeinfoPage.treeName}'>
			...
			<td class="value">
					<%--<t:dictSelect field="actId" type="list"
						dictTable="ACT_RE_PROCDEF" dictField="ID_" dictText="NAME_" defaultVal="${tSTreeinfoPage.actId}" hasLabel="false"  title="流程实例"></t:dictSelect>--%>
						<input class="easyui-combobox" id="actId"  value="${tSTreeinfoPage.actId}" name="actId" data-options="valueField: 'id',
						textField: 'value',
						panelHeight:200,
						editable:false,
						url:'cgFormHeadController.do?loadFlowInfo&isAll=1&billId=${tSTreeinfoPage.id }'" >
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value" colspan="3">
				 <textarea id="note" style="width:600px;" class="inputxt" rows="6" name="note">${tSTreeinfoPage.note}</textarea>
				<span class="Validform_checktip"></span>
