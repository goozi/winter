...
<%--update-start--Author:Zerrion  Date:20140827 for：添加 组织机构查询条件--%>
<script>
  $(function () {
...
<%--update-end--Author:Zerrion  Date:20140827 for：添加 组织机构查询条件--%>
...
<t:datagrid name="userList" title="用户管理" actionUrl="userController.do?datagrid"
  ...
  <%--update-start--Author:Zerrion  Date:20140827 for：通过用户对象的关联属性值获取组织机构名称（多对多关联）--%>
  ...
  <%--update-end--Author:Zerrion  Date:20140827 for：通过用户对象的关联属性值获取组织机构名称（多对多关联）--%>
  ...
  <t:dgCol title="common.status" sortable="true" field="status" query="true"
  ...
  <t:dgToolBar title="common.add.param" operationCode="add" langArg="common.user" icon="new-icon-add" url="userController.do?addorupdate"
               funname="add" height="430" windowType="tab"></t:dgToolBar>
  <t:dgToolBar title="common.edit.param" operationCode="editBtn" langArg="common.user" icon="new-icon-edit" url="userController.do?addorupdate"
               funname="update" height="430" windowType="tab"></t:dgToolBar>
  <t:dgToolBar title="common.password.reset" operationCode="resetBtn" icon="new-icon-unclose" url="userController.do?changepasswordforuser"
               funname="update" windowType="tab"></t:dgToolBar>
  <t:dgToolBar title="common.lock.user" operationCode="lockBtn" icon="new-icon-disable" url="userController.do?lock&lockvalue=0"
               funname="lockObj"></t:dgToolBar>
  <t:dgToolBar title="common.unlock.user" operationCode="unlockBtn" icon="new-icon-enable" url="userController.do?lock&lockvalue=1"
...
<%--update-start--Author:Zerrion  Date:20140827 for：添加 组织机构查询条件：弹出 选择组织机构列表 相关操作--%>
...
<%--update-end--Author:Zerrion  Date:20140827 for：添加 组织机构查询条件：弹出 选择组织机构列表 相关操作--%>
