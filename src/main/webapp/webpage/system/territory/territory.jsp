  ...
  <fieldset class="step">
    ...
    <div class="form">
      ...
      <select name="territoryLevel" id="territoryLevel" datatype="*">
        <option value="0" <c:if test="${territory.territoryLevel eq 0}">selected="selected"</c:if>><t:mutiLang
                langKey="main.area"/></option>
        <option value="1" <c:if test="${territory.territoryLevel>0}"> selected="selected"</c:if>><t:mutiLang
                langKey="sub.area"/></option>
      </select>
