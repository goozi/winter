...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:1px;">
        <t:datagrid name="tScIcInventoryBatchnoList" checkbox="true" fitColumns="false" title="商品批号明细" tableName="t_sc_ic_inventory_batchno"
                    actionUrl="tScIcInventoryController.do?datagridBatchNo&itemId=${itemId}&stockId=${stockId}" idField="id" fit="true"
                    queryMode="group">
            ...
            <t:dgCol title="商品编号" field="itemNo" query="false" hidden="true"  queryMode="single"   width="100"></t:dgCol>
            <t:dgCol title="商品名称" field="itemName" hidden="true" queryMode="single"   width="100"></t:dgCol>
            <t:dgCol title="条形码" field="barCode" hidden="true" queryMode="single"   width="100"></t:dgCol>
            <t:dgCol title="仓库" field="stockName" hidden="true"  queryMode="single"   width="100"></t:dgCol>
            ...
            <t:dgCol title="箱数" field="qty" extendParams="formatter:function (v,r,i){var CFG_NUMBER = $('#CFG_NUMBER').val(); if(!v){v = 0}; return parseFloat(v).toFixed(CFG_NUMBER)},"   queryMode="single"   width="100"></t:dgCol>
            <t:dgCol title="散数" field="smallQty"  extendParams="formatter:function (v,r,i){var CFG_NUMBER = $('#CFG_NUMBER').val(); if(!v){v = 0}; return parseFloat(v).toFixed(CFG_NUMBER)},"  queryMode="single"   width="100"></t:dgCol>
            <t:dgCol title="基本数量" field="basicQty" extendParams="formatter:function (v,r,i){var CFG_NUMBER = $('#CFG_NUMBER').val(); if(!v){v = 0}; return parseFloat(v).toFixed(CFG_NUMBER)},"   queryMode="single"   width="100"></t:dgCol>
            <t:dgCol title="辅助数量" field="secQty" extendParams="formatter:function (v,r,i){var CFG_NUMBER = $('#CFG_NUMBER').val(); if(!v){v = 0}; return parseFloat(v).toFixed(CFG_NUMBER)},"   queryMode="single"   width="100"></t:dgCol>
            <t:dgCol title="存货单价" field="costPrice"  extendParams="formatter:function (v,r,i){var CFG_NUMBER = $('#CFG_UNITP_RICE').val(); if(!v){v = 0}; return parseFloat(v).toFixed(CFG_NUMBER)},"  queryMode="single"   width="100"></t:dgCol>
            <t:dgCol title="存货金额" field="costAmount"  extendParams="formatter:function (v,r,i){var CFG_NUMBER = $('#CFG_MONEY').val(); if(!v){v = 0}; return parseFloat(v).toFixed(CFG_NUMBER)},"   queryMode="single"   width="100"></t:dgCol>
