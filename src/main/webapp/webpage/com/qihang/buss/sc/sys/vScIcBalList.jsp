            ...
            <a name="addTScIcBalBtn[0]" id="addTScIcBalBtn[0]" href="#"
               onclick="clickAddTScIcBalBtn(0);"></a>
				  ...
				  <td align="left" bgcolor="white">
					  	<input name="tScIcBalList[0].itemname" maxlength="32"
					  		type="text" class="inputxt"  style="width:120px;" >
					  <label class="Validform_label" style="display: none;">商品</label>
					</td>
				  <td align="left" bgcolor="white">
					  	<input name="tScIcBalList[0].stockname" maxlength="32"
					  		type="text" class="inputxt"  style="width:120px;" >
				...
				<td align="left" bgcolor="white">
					<input name="tScIcBalList[0].departname" maxlength="32"
						   type="text" class="inputxt"  style="width:120px;" >
            ...
            <a name="addTScIcBalBtn[${stuts.index}]" id="addTScIcBalBtn[${stuts.index}]" href="#"
              ...
              <a name="delTScIcBalBtn[${stuts.index}]" id="delTScIcBalBtn[${stuts.index}]" href="#"
                 onclick="clickDelTScIcBalBtn(${stuts.index});"></a>
				   ...
				   <td align="left" bgcolor="white">
					  	<input name="tScIcBalList[${stuts.index }].itemname" maxlength="32"
					  		type="text" class="inputxt"  style="width:120px;"
					  		 value="${poVal.itemname }">
					  <label class="Validform_label" style="display: none;">商品</label>
				   </td>
				   <td align="left" bgcolor="white">
					  	<input name="tScIcBalList[${stuts.index }].stockname" maxlength="32"
					  		type="text" class="inputxt"  style="width:120px;"
				...
				<td align="left" bgcolor="white">
					<input name="tScIcBalList[${stuts.index }].departname" maxlength="32"
						   type="text" class="inputxt"  style="width:120px;"
