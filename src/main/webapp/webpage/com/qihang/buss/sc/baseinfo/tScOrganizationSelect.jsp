...
<div class="easyui-layout" fit="true">
    ...
    <div region="center" style="padding:1px;">
        <t:datagrid name="tScOrganizationList" checkbox="false" fitColumns="false" title="客户" colConfig="false"
                    actionUrl="tScOrganizationController.do?datagridSelect&typeid=${param.typeid}"
                    checkOnSelect="true" idField="id" fit="true"
            ...
            <t:dgCol title="结算单位" field="settlecompany" hidden="true" dictionary="t_sc_organization,id,name" queryMode="single" width="120"></t:dgCol>
            <t:dgCol title="开户银行" field="bank" queryMode="single" hidden="true" dictionary="SC_BANK" width="120"></t:dgCol>
            <t:dgCol title="银行账号" field="banknumber" queryMode="single" hidden="true" width="120"></t:dgCol>
            <t:dgCol title="客户分类" field="typeid"    queryMode="single"  dictionary="SC_TYPE_ID" width="70"></t:dgCol>

            <%--<t:dgCol title="客户分类" field="typeid" queryMode="single" dictionary="SC_CUSTOMER_TYPE" width="120"></t:dgCol>--%>
            <t:dgCol title="上级经销商" field="dealer" queryMode="single" hidden="true" width="120"></t:dgCol>
            <t:dgCol title="默认业务员" field="defaultoperator" hidden="true" queryMode="single" width="120"></t:dgCol>
            <t:dgCol title="送货方式" field="delivertype" queryMode="single" hidden="true" dictionary="SC_DELIVER_TYPE"
                     width="120"></t:dgCol>
            ...
            <t:dgCol title="传真" field="fax" queryMode="single" hidden="true" width="120"></t:dgCol>
            <t:dgCol title="邮政编码" hidden="true" field="postalcode" queryMode="single" width="120"></t:dgCol>
            ...
            <t:dgCol title="行业" field="trade" queryMode="single" hidden="true" dictionary="SC_TRADE" width="120"></t:dgCol>
            ...
            <t:dgCol title="禁用标记" field="disable" hidden="true" queryMode="single" replace="启用_0,禁用_1" width="120"></t:dgCol>
...
<script type="text/javascript">
   ...
   <%--var flag = true;--%>
    <%--function loadsuccess(){--%>
        <%--if(flag) {--%>
            <%--&lt;%&ndash;$("input[name='name']").val('${name}');&ndash;%&gt;--%>
            <%--&lt;%&ndash;$('.icon-query').click();&ndash;%&gt;--%>
<%--//            $("input[name='name']").val('');--%>
            <%--flag = false;--%>
        <%--}--%>
    <%--}--%>
