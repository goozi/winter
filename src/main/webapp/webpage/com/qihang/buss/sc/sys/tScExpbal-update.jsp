...
<!--20160629页脚样式 -->
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tScExpbalController.do?doUpdate" tiptype="1">
					<input id="id" name="id" type="hidden" value="${tScExpbalPage.id }">
					<input id="createName" name="createName" type="hidden" value="${tScExpbalPage.createName }">
					<input id="createBy" name="createBy" type="hidden" value="${tScExpbalPage.createBy }">
					<input id="createDate" name="createDate" type="hidden" value="${tScExpbalPage.createDate }">
					<input id="updateName" name="updateName" type="hidden" value="${tScExpbalPage.updateName }">
					<input id="updateBy" name="updateBy" type="hidden" value="${tScExpbalPage.updateBy }">
					<input id="updateDate" name="updateDate" type="hidden" value="${tScExpbalPage.updateDate }">
