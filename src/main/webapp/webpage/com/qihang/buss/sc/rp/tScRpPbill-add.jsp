...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                type: "get",
                url: "tScRpPbillController.do?tScRpPbillentry1List&id=${tScRpPbillPage.id}",
            ...
            $.ajax({
                type: "get",
                url: "tScRpPbillController.do?tScRpPbillentry2List&id=${tScRpPbillPage.id}",
                success:function(data){
                    $("#southBody").html(data);
...
<t:formvalid formid="formobj" dialog="true" title="付款单" usePlugin="password" layout="table" tiptype="1" beforeSubmit="checkAllAmount"
             action="tScRpPbillController.do?doAdd" saveTemp="true">
