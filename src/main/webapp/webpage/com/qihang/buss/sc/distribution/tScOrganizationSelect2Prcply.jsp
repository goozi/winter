...
<div class="easyui-layout" fit="true">
    ...
    <div region="center" style="padding:1px;">
        <t:datagrid name="tScOrganizationList" checkbox="true" fitColumns="false" title="客户"
                    actionUrl="tScPrcplyController.do?datagridSelect&disable=0&deleted=0" checkOnSelect="true" idField="id" fit="true" onLoadSuccess="loadsuccess"
            ...
            <t:dgCol title="上级经销商" field="dealer" queryMode="single"  width="120" dictionary="t_sc_organization,id,name"></t:dgCol>
