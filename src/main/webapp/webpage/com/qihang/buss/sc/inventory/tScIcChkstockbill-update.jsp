...
<html>
 ...
 <input id="load" value="${load}" type="hidden">
  <t:formvalid formid="formobj" tranType="160" tableName="t_sc_ic_chkstockbill" title="盘点单" dialog="true" usePlugin="password" layout="table" tiptype="1" action="tScIcChkstockbillController.do?doUpdate">
					...
					<input id="tranType" name="tranType" type="hidden" value="${tScIcChkstockbillPage.tranType }">
					<input id="pdDate" name="pdDate" type="hidden" value="${tScIcChkstockbillPage.pdDate }">
					<input id="checkState" name="checkState" type="hidden" value="${tScIcChkstockbillPage.checkState }">
					<input id="cancellation" name="cancellation" type="hidden" value="${tScIcChkstockbillPage.cancellation }">
	  				<input id="billerId" name="billerId" type="hidden" value="${tScIcChkstockbillPage.billerId }">
					<input id="sonId" name="sonId" type="hidden" value="${tScIcChkstockbillPage.sonId }">
	  				<input id="billNo" name="billNo" type="hidden" value="${tScIcChkstockbillPage.billNo }">
	  				<input name="date" type="hidden" value="${tScIcChkstockbillPage.date }">
	  				<input id="stockId" name="stockId" type="hidden" value="${tScIcChkstockbillPage.stockId }">
	  				<input id="empId" name="empId" type="hidden" value="${tScIcChkstockbillPage.empId }">
	  				<input id="deptId" name="deptId" type="hidden" value="${tScIcChkstockbillPage.deptId }">
	  				<input id="isAuto" name="isAuto" type="hidden" value="${tScIcChkstockbillPage.isAuto }">
	  				<input id="chkType" name="chkType" type="hidden" value="${tScIcChkstockbillPage.chkType }">
	  				<input id="version" name="version"  type="hidden" value="${tScIcChkstockbillPage.version }">
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
				<input id="stockName" name="stockName" type="text" style="width: 150px" class="inputxt popup-select"  datatype="*" value='${tScIcChkstockbillPage.stockName}'>
			...
			<td class="value">
				<input id="empName" name="empName" type="text" style="width: 150px" class="inputxt popup-select"  datatype="*" value='${tScIcChkstockbillPage.empName}'>
				<span class="Validform_checktip">
                      *
				</span>
			...
			<td class="value">
				<input id="deptName" name="deptName" type="text" style="width: 150px" class="inputxt popup-select"  datatype="*" value='${tScIcChkstockbillPage.deptName}'>
				<span class="Validform_checktip">
                      *
				</span>
		...
		<tr>
			...
			<td class="value">
				<t:dictSelect field="chkType_" width="150" type="list" showDefaultOption="true" extendJson="{onChange:setChkType()}"
							  typeGroupCode="SC_ChkType" defaultVal="${tScIcChkstockbillPage.chkType}" hasLabel="false"  title="盘点类型"></t:dictSelect>
				<span class="Validform_checktip">
				</span>
			...
			<td class="value" colspan="3">
				<input id="explanation" name="explanation" type="text" style="width: 69%" class="inputxt" value='${tScIcChkstockbillPage.explanation}'>
				<span class="Validform_checktip">
				</span>
		...
		<tr>
			...
			<div style="width: auto;height: 200px;">
				...
				<t:tabs id="tt" iframe="false" tabPosition="top" fit="false">
				 <t:tab href="tScIcChkstockbillController.do?tScIcChkstockbillentryList&id=${tScIcChkstockbillPage.id}" icon="icon-search" title="盘点单明细" id="tScIcChkstockbillentry"></t:tab>
				</t:tabs>
			</div>
			</t:formvalid>
			<!-- 添加 附表明细 模版 -->
		...
		<tbody id="add_tScIcChkstockbillentry_table_template">
         ...
         <div style="width: 80px;">
           <a name="addTScIcChkstockbillentryBtn[#index#]" id="addTScIcChkstockbillentryBtn[#index#]" href="#"  onclick="clickAddTScIcChkstockbillentryBtn('#index#');"></a>
           <a name="delTScIcChkstockbillentryBtn[#index#]" id="delTScIcChkstockbillentryBtn[#index#]" href="#"  onclick="clickDelTScIcChkstockbillentryBtn('#index#');"></a>
         </div>
       </td>
				...
				<td align="left" bgcolor="white">
					<input name="tScIcChkstockbillentryList[#index#].itemName" maxlength="32"
						   type="text" class="inputxt" style="width:180px;"/>
					<label class="Validform_label" style="display: none;">商品名称</label>
				</td>
				<td align="left" bgcolor="white">
					<input name="tScIcChkstockbillentryList[#index#].model" maxlength="32"
						   type="text" class="inputxt" style="width:85px;"/>
					<label class="Validform_label" style="display: none;">规格</label>
				</td>
				<td align="left" bgcolor="white">
					<input name="tScIcChkstockbillentryList[#index#].barCode" maxlength="32"
				...
				<%--</td>--%>
				<td align="left" bgcolor="white">
					<input name="tScIcChkstockbillentryList[#index#].batchNo" maxlength="100"
				...
				<td align="left" bgcolor="white">
					<input name="tScIcChkstockbillentryList[#index#].qty" maxlength="20"
						   type="text" class="inputxt" style="width:70px;" />
					<label class="Validform_label" style="display: none;">账面箱数</label>
				</td>
				<td align="left" bgcolor="white">
					<input name="tScIcChkstockbillentryList[#index#].smallQty" maxlength="20"
						   type="text" class="inputxt" style="width:70px;" />
					<label class="Validform_label" style="display: none;">账面散数</label>
				</td>
				<td align="left" bgcolor="white">
					<input name="tScIcChkstockbillentryList[#index#].basicQty" maxlength="20"
						   type="text" class="inputxt" style="width:70px;" />
					<label class="Validform_label" style="display: none;">账面数量</label>
				</td>
				<td align="left" bgcolor="white">
					<input name="tScIcChkstockbillentryList[#index#].coefficient" maxlength="20"
						   type="text" class="inputxt" style="width:65px;" />
				...
				<td align="left" bgcolor="white">
					<input name="tScIcChkstockbillentryList[#index#].diffQty" maxlength="20"
						   type="text" class="inputxt" style="width:70px;" />
					<label class="Validform_label" style="display: none;">差异数量</label>
				</td>
				<td align="left" bgcolor="white">
					<input name="tScIcChkstockbillentryList[#index#].costPrice" maxlength="20"
						   type="text" class="inputxt" style="width:70px;" />
					<label class="Validform_label" style="display: none;">成本单价</label>
				</td>
				<td align="left" bgcolor="white">
					<input name="tScIcChkstockbillentryList[#index#].amount" maxlength="20"
						   type="text" class="inputxt" style="width:70px;" />
					<label class="Validform_label" style="display: none;">账面金额</label>
				</td>
				<td align="left" bgcolor="white">
					<input name="tScIcChkstockbillentryList[#index#].chkAmount" maxlength="20"
						   type="text" class="inputxt" style="width:70px;" />
					<label class="Validform_label" style="display: none;">盘点金额</label>
				</td>
				<td align="left" bgcolor="white">
					<input name="tScIcChkstockbillentryList[#index#].diffAmount" maxlength="20"
						   type="text" class="inputxt" style="width:70px;" />
...
<!--20160629  页脚显示 -->
  <div style="width:100%;position: absolute;bottom: 10px;left:10px;" id="footdiv">
	  <div style="width: 33%;display:inline;float: left" align="left">
		  ...
		  <span  class="inputxt footspan"> ${tScIcChkstockbillPage.billerName}</span>
	  </div>
	  <div style="width: 33%;display: inline;float: left" align="left">
