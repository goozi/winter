...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tScIcitemList" checkbox="false" checkOnSelect="true" fitColumns="false" title="商品主表" actionUrl="tScIcitemController.do?datagridMain&disabled=0" idField="id" fit="true" queryMode="group">
