...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                type: "get",
                url: "tScIcXsstockbillController.do?tScIcXsstockbillentry1List&id=${tScIcXsstockbillPage.id}",
            ...
            $.ajax({
                type: "get",
                url: "tScIcXsstockbillController.do?tScIcXsstockbillentry2List&id=${tScIcXsstockbillPage.id}",
                success:function(data){
                    $("#southBody").html(data);
...
<t:formvalid formid="formobj" dialog="true" title="销售换货单" usePlugin="password" layout="table" tiptype="1" beforeSubmit="checkPriceIsZero"
             action="tScIcXsstockbillController.do?doAdd" saveTemp="true">
...
<table style="display:none">
    ...
    <tr>
        ...
        <td align="left" bgcolor="white">
            <input name="tScIcXsstockbillentry1List[#index#].itemNo" maxlength="32" datatype="*"
        ...
        <td align="left" bgcolor="white">
            <input name="tScIcXsstockbillentry1List[#index#].stockName" maxlength="32" datatype="*"
        ...
        <td align="left" bgcolor="white">
            <input name="tScIcXsstockbillentry1List[#index#].kfDate" maxlength="20" type="text" class="Wdate" onClick="WdatePicker()" style="width:80px;"/>
