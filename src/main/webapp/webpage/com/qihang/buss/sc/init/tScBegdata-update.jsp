...
<!--20160629页脚样式 -->
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" title="${title}" usePlugin="password" layout="table" saveTemp="true"
			   action="tScBegdataController.do?doUpdate" tiptype="1" tranType="${tScBegdataPage.tranType }" tableName="T_SC_BEGDATA">
...
<!--页脚字段显示 -->
  ...
  <script src = "webpage/com/qihang/buss/sc/init/tScBegdata.js"></script>		