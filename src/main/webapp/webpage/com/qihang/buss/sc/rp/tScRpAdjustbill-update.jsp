...
<t:formvalid formid="formobj" dialog="true" title="${title}" tranType="${tScRpAdjustbillPage.tranType }" tableName="t_sc_rp_adjustbill" usePlugin="password" layout="table" tiptype="1"
			 action="tScRpAdjustbillController.do?doUpdate" saveTemp="true">
	...
	<input id="idSrc" name="idSrc" value="${tScRpAdjustbillPage.idSrc }" type="hidden">
	...
	<input id="checkDate" name="checkDate" type="hidden" value="${tScRpAdjustbillPage.checkDate }">
	...
	<input id="empId" name="empId" type="hidden" value="${tScRpAdjustbillPage.empId }">
	<input id="deptId" name="deptId" type="hidden" value="${tScRpAdjustbillPage.deptId }">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
				<input id="itemName" name="itemName" type="text" value="${tScRpAdjustbillPage.itemName }" style="width: 150px" class="inputxt popup-select" datatype="*"
						>
      <span class="Validform_checktip">*
			...
			<td class="value">
				<input id="empName" name="empName" type="text" value="${tScRpAdjustbillPage.empName }" style="width: 150px" class="inputxt popup-select" datatype="*"
						>
      <span class="Validform_checktip">*
                </span>
			...
			<td class="value">
				<input id="deptName" name="deptName" type="text" value="${tScRpAdjustbillPage.deptName }" style="width: 150px" class="inputxt popup-select" datatype="*"
						>
      <span class="Validform_checktip">*
                </span>
		...
		<tr>
			...
			<td class="value">
				<input id="allAmount" name="allAmount" value="${tScRpAdjustbillPage.allAmount }" readonly="readonly" type="text" style="width: 150px" class="inputxt"
						>
      <span class="Validform_checktip">
                </span>
			...
			<td class="value">
				<input id="sonName" name="sonName" readonly="readonly" value="${tScRpAdjustbillPage.sonName }" type="text" style="width: 150px" class="inputxt"
						>
      <span class="Validform_checktip">
                </span>
		...
		<tr>
			...
			<td class="value" colspan="5">
				<input id="explanation" name="explanation" value="${tScRpAdjustbillPage.explanation }" type="text" style="width: 47%;" class="inputxt"
						>
      <span class="Validform_checktip">
                </span>
	...
	<div style="width: auto;height: 200px;">
		...
		<t:tabs id="tt" iframe="false" tabPosition="top" fit="false">
			<t:tab href="tScRpAdjustbillController.do?tScRpAdjustbillentryList&id=${tScRpAdjustbillPage.id}&load=${load}"
...
<div style="width:100%;position: absolute;bottom: 10px;left:10px;" id="footdiv">
	<div style="width: 33%;display:inline;float: left" align="left">
		...
		<span class="inputxt footspan"> ${tScRpAdjustbillPage.billerName}</span>
	</div>
	<div style="width: 33%;display: inline;float: left" align="left">
