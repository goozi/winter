...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" beforeSubmit="checkName()"
             action="tScEmpController.do?doAdd" tiptype="1">
      <input id="id" name="id" type="hidden"
             value="${tScEmpPage.id }">
      <input id="createName" name="createName" type="hidden"
             value="${tScEmpPage.createName }">
      <input id="createBy" name="createBy" type="hidden"
             value="${tScEmpPage.createBy }">
      <input id="createDate" name="createDate" type="hidden"
             value="${tScEmpPage.createDate }">
      <input id="updateName" name="updateName" type="hidden"
             value="${tScEmpPage.updateName }">
      <input id="updateBy" name="updateBy" type="hidden"
             value="${tScEmpPage.updateBy }">
      <input id="updateDate" name="updateDate" type="hidden"
             value="${tScEmpPage.updateDate }">
      <input id="parentID" name="parentID" type="hidden"
             value="${parentID }">
      <input id="disabled" name="disabled" type="hidden"
             value="${tScEmpPage.disabled }">
      <input id="deleted" name="deleted" type="hidden"
             value="${tScEmpPage.deleted }">
      <input id="version" name="version" type="hidden"
             value="${tScEmpPage.version }">
      <input id="level" name="level" type="hidden"
             value="${tScEmpPage.level }">
      <input id="count" name="count" type="hidden"
             value="${tScEmpPage.count }">
      <input id="userId" name="userId" type="hidden"
             value="${tScEmpPage.userId }">
      ...
      <label class="Validform_label" style="display: none;">助记码</label>
              ...
              <td class="value">
                  <t:dictSelect field="gender" type="list"
                                typeGroupCode="SC_GENDER"
                                defaultVal="0001" hasLabel="false"
                                title="性别" showDefaultOption="false"></t:dictSelect>
      <span class="Validform_checktip">
      </span>
          ...
          <tr>
              ...
              <td class="value">
                  <t:dictSelect field="duty" type="list"
                                typeGroupCode="SC_DUTY_TYPE"
                                defaultVal="${tScEmpPage.duty}" hasLabel="false"
                                title="职务"></t:dictSelect>
      <span class="Validform_checktip">
      </span>
              ...
              <td class="value">
                  <t:dictSelect field="degree" type="list"
                                typeGroupCode="SC_CULTURE_TYPE"
                                defaultVal="${tScEmpPage.degree}" hasLabel="false"
                                title="文化程度"></t:dictSelect>
      <span class="Validform_checktip">
      </span>
          ...
          <tr>
              ...
              <td class="value">
                  <t:dictSelect field="empGroup" type="list"
                                typeGroupCode="SC_EMPLOYEE_TYPE"
                                defaultVal="${tScEmpPage.empGroup}" hasLabel="false"
                                title="职员类别"></t:dictSelect>
      <span class="Validform_checktip">
      </span>
      ...
      <span class="Validform_checktip">
              ...
              <td class="value">
                  <t:dictSelect field="bank" type="list"
                                ...
                                defaultVal="${tScEmpPage.bank}" hasLabel="false"
      ...
      <tr>
          ...
          <td class="value">
              <input id="creditAmount" name="creditAmount" type="text" style="width: 150px" class="inputxt"
                     datatype="d"   onblur="checkcreditamount(this)"
                     >
              <span class="Validform_checktip">
              </span>
