...
<!--20160629页脚样式 -->
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="vScCheckspeedbalController.do?doUpdate" tiptype="1">
					<input id="stockid" name="stockid" type="hidden" value="${vScCheckspeedbalPage.stockid }">
					<input id="itemid" name="itemid" type="hidden" value="${vScCheckspeedbalPage.itemid }">
					<input id="id" name="id" type="hidden" value="${vScCheckspeedbalPage.id }">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="date" name="date" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${vScCheckspeedbalPage.date}'>
						...
						<td class="value">
						     	 <input id="batchno" name="batchno" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${vScCheckspeedbalPage.batchno}'>
							<span class="Validform_checktip">
							</span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="qty" name="qty" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${vScCheckspeedbalPage.qty}'>
							<span class="Validform_checktip">
							</span>
						...
						<td class="value">
						     	 <input id="secqty" name="secqty" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${vScCheckspeedbalPage.secqty}'>
							<span class="Validform_checktip">
							</span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="sonname" name="sonname" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${vScCheckspeedbalPage.sonname}'>
							<span class="Validform_checktip">
							</span>
						...
						<td class="value">
						     	 <input id="departmentname" name="departmentname" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${vScCheckspeedbalPage.departmentname}'>
							<span class="Validform_checktip">
							</span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="itemname" name="itemname" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${vScCheckspeedbalPage.itemname}'>
							<span class="Validform_checktip">
							</span>
						...
						<td class="value">
						     	 <input id="itemnumber" name="itemnumber" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${vScCheckspeedbalPage.itemnumber}'>
							<span class="Validform_checktip">
							</span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="unitname" name="unitname" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${vScCheckspeedbalPage.unitname}'>
							<span class="Validform_checktip">
							</span>
						...
						<td class="value">
						     	 <input id="coefficient" name="coefficient" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${vScCheckspeedbalPage.coefficient}'>
							<span class="Validform_checktip">
							</span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="bigqty" name="bigqty" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${vScCheckspeedbalPage.bigqty}'>
							<span class="Validform_checktip">
							</span>
						...
						<td class="value">
						     	 <input id="smallqty" name="smallqty" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${vScCheckspeedbalPage.smallqty}'>
							<span class="Validform_checktip">
							</span>
