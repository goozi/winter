...
<table border="0" cellpadding="2" cellspacing="1" totalRow="true"  id="tScRpAdjustbillentry_table" style="background-color: #cbccd2">
    ...
    <c:if test="${fn:length(tScRpAdjustbillentryList)  <= 0 }">
        <tr>
            ...
            <input name="tScRpAdjustbillentryList[0].expId" type="hidden" datatype="*"/>
            ...
            <td align="left" bgcolor="white">
                <input name="tScRpAdjustbillentryList[0].amount" maxlength="10"
    ...
    <c:if test="${fn:length(tScRpAdjustbillentryList)  > 0 }">
        <c:forEach items="${tScRpAdjustbillentryList}" var="poVal" varStatus="stuts">
            <tr>
                ...
                <td align="center" bgcolor="white">
                    <div style="width: 80px;background-color: white;">
                        <a name="addTScRpAdjustbillentryBtn[${stuts.index}]" id="addTScRpAdjustbillentryBtn[${stuts.index}]" href="#"
                           onclick="clickAddTScRpAdjustbillentryBtn(${stuts.index});"></a>

                        <a name="delTScRpAdjustbillentryBtn[${stuts.index}]" id="delTScRpAdjustbillentryBtn[${stuts.index}]" href="#"
                ...
                <input name="tScRpAdjustbillentryList[${stuts.index }].createName" type="hidden" value="${poVal.createName }"/>
                <input name="tScRpAdjustbillentryList[${stuts.index }].createBy" type="hidden" value="${poVal.createBy }"/>
                <input name="tScRpAdjustbillentryList[${stuts.index }].createDate" type="hidden" value="${poVal.createDate }"/>
                <input name="tScRpAdjustbillentryList[${stuts.index }].updateName" type="hidden" value="${poVal.updateName }"/>
                <input name="tScRpAdjustbillentryList[${stuts.index }].updateBy" type="hidden" value="${poVal.updateBy }"/>
                <input name="tScRpAdjustbillentryList[${stuts.index }].updateDate" type="hidden" value="${poVal.updateDate }"/>
                ...
                <input name="tScRpAdjustbillentryList[${stuts.index }].expId" type="hidden" value="${poVal.expId }" datatype="*"/>
                <td align="left" bgcolor="white">
                ...
                <td align="left" bgcolor="white">
                    <input name="tScRpAdjustbillentryList[${stuts.index }].amount" maxlength="10"
