...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1"
      ...
      <input id="id" name="id" type="hidden"
             value="${tScIcChkstockbillPage.id }">
      <input id="createName" name="createName" type="hidden"
             value="${tScIcChkstockbillPage.createName }">
      <input id="createBy" name="createBy" type="hidden"
             value="${tScIcChkstockbillPage.createBy }">
      <input id="createDate" name="createDate" type="hidden"
             value="${tScIcChkstockbillPage.createDate }">
      <input id="updateName" name="updateName" type="hidden"
             value="${tScIcChkstockbillPage.updateName }">
      <input id="updateBy" name="updateBy" type="hidden"
             value="${tScIcChkstockbillPage.updateBy }">
      <input id="updateDate" name="updateDate" type="hidden"
             value="${tScIcChkstockbillPage.updateDate }">
      <input id="tranType" name="tranType" type="hidden"
             value="160">
      <input id="pdDate" name="pdDate" type="hidden"
             value="${tScIcChkstockbillPage.pdDate }">
      ...
      <input id="sonId" name="sonId" type="hidden"
             value="${tScIcChkstockbillPage.sonId }">
    ...
    <td class="value">
      ...
      <span class="Validform_checktip">
          *
          ...
          <td class="value">
              <input id="chkType" name="chkType" type="text" style="width: 150px" class="inputxt"
                      >
              <t:dictSelect field="chkType" width="150" type="list" showDefaultOption="true"
                            typeGroupCode="SC_DURA_DATE_TYPE" defaultVal="" hasLabel="false"  title="盘点类型"></t:dictSelect>
      <span class="Validform_checktip">
                </span>
          ...
          <input name="tScIcChkstockbillentryList[#index#].stockId" type="hidden"/>
            <td align="left" bgcolor="white">
                  <input name="tScIcChkstockbillentryList[#index#].itemNo" maxlength="32"
                         type="text" class="inputxt" style="width:105px;"/>
            ...
            <td align="left" bgcolor="white">
                  <input name="tScIcChkstockbillentryList[#index#].unitId" maxlength="32"
            ...
            <td align="left" bgcolor="white">
                  <input name="tScIcChkstockbillentryList[#index#].coefficient" maxlength="20"
                         type="text" class="inputxt" style="width:65px;" datatype="num"/>
