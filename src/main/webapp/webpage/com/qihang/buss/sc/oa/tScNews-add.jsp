...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table"
             action="tScNewsController.do?doAdd" tiptype="1">
    <input id="id" name="id" type="hidden"
           value="${tScNewsPage.id }">
    <input id="createName" name="createName" type="hidden"
           value="${tScNewsPage.createName }">
    <input id="createBy" name="createBy" type="hidden"
           value="${tScNewsPage.createBy }">
    <input id="createDate" name="createDate" type="hidden"
           value="${tScNewsPage.createDate }">
    <input id="updateName" name="updateName" type="hidden"
           value="${tScNewsPage.updateName }">
    <input id="updateBy" name="updateBy" type="hidden"
           value="${tScNewsPage.updateBy }">
    <input id="updateDate" name="updateDate" type="hidden"
           value="${tScNewsPage.updateDate }">
    <input id="issuance" name="issuance" type="hidden"
           value="${tScNewsPage.issuance }">
    <input id="issuanceDate" name="issuanceDate" type="hidden"
           value="${tScNewsPage.issuanceDate }">
    <table cellpadding="0" cellspacing="1" class="formtable">
        <tr>
            ...
            <td class="value">
                <input id="title" name="title" type="text" style="width: 580px" class="inputxt" datatype="*1-100" maxlength="100">
        ...
        <tr>
            ...
            <td class="value">
                <t:dictSelect field="type" type="list"
                              ...
                              defaultVal="${tScNewsPage.type}" hasLabel="false"
