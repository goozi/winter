...
<!--20160629页脚样式 -->
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tScIcSpeedbalController.do?doUpdate" tiptype="1">
					<input id="id" name="id" type="hidden" value="${tScIcSpeedbalPage.id }">
					<input id="createName" name="createName" type="hidden" value="${tScIcSpeedbalPage.createName }">
					<input id="createBy" name="createBy" type="hidden" value="${tScIcSpeedbalPage.createBy }">
					<input id="createDate" name="createDate" type="hidden" value="${tScIcSpeedbalPage.createDate }">
					<input id="updateName" name="updateName" type="hidden" value="${tScIcSpeedbalPage.updateName }">
					<input id="updateBy" name="updateBy" type="hidden" value="${tScIcSpeedbalPage.updateBy }">
					<input id="updateDate" name="updateDate" type="hidden" value="${tScIcSpeedbalPage.updateDate }">
					<input id="billId" name="billId" type="hidden" value="${tScIcSpeedbalPage.billId }">
					<input id="billEntryId" name="billEntryId" type="hidden" value="${tScIcSpeedbalPage.billEntryId }">
					...
					<tr>
						...
						<td class="value">
									  <input id="date" name="date" type="text" style="width: 150px" 
						      						class="Wdate" onClick="WdatePicker()"
						      						 ...
						      						 value='<fmt:formatDate value='${tScIcSpeedbalPage.date}' type="date" pattern="yyyy-MM-dd"/>'>    
						...
						<td class="value">
						     	 <input id="tranType" name="tranType" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${tScIcSpeedbalPage.tranType}'>
							<span class="Validform_checktip">
							</span>
					...
					<tr>
						...
						<td class="value">
									  <input id="billCreateTime" name="billCreateTime" type="text" style="width: 150px" 
						      						class="Wdate" onClick="WdatePicker()"
						      						 ...
						      						 value='<fmt:formatDate value='${tScIcSpeedbalPage.billCreateTime}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip">
							</span>
						...
						<td class="value">
						     	 <input id="itemId" name="itemId" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${tScIcSpeedbalPage.itemId}'>
							<span class="Validform_checktip">
							</span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="stockId" name="stockId" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${tScIcSpeedbalPage.stockId}'>
							<span class="Validform_checktip">
							</span>
						...
						<td class="value">
						     	 <input id="batchNo" name="batchNo" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${tScIcSpeedbalPage.batchNo}'>
							<span class="Validform_checktip">
							</span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="secQty" name="secQty" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${tScIcSpeedbalPage.secQty}'>
							<span class="Validform_checktip">
							</span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="amount" name="amount" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${tScIcSpeedbalPage.amount}'>
							<span class="Validform_checktip">
							</span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="ePrice" name="ePrice" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${tScIcSpeedbalPage.ePrice}'>
							<span class="Validform_checktip">
							</span>
						...
						<td class="value">
						     	 <input id="eAmount" name="eAmount" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${tScIcSpeedbalPage.eAmount}'>
							<span class="Validform_checktip">
							</span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="diffAmount" name="diffAmount" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${tScIcSpeedbalPage.diffAmount}'>
							<span class="Validform_checktip">
							</span>
						...
						<td class="value">
						     	 <input id="blidSrc" name="blidSrc" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${tScIcSpeedbalPage.blidSrc}'>
							<span class="Validform_checktip">
							</span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="status" name="status" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${tScIcSpeedbalPage.status}'>
							<span class="Validform_checktip">
							</span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="negFlag" name="negFlag" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${tScIcSpeedbalPage.negFlag}'>
							<span class="Validform_checktip">
							</span>
