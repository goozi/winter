...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" title="其他收入单"
             action="tScRpRotherbillController.do?doAdd" saveTemp="true">
      ...
      <input id="tranType" name="tranType" type="hidden" value="${tranType}" datatype="*">
    <input id="billerId" name="billerId" type="hidden" value="${billerId}" datatype="*">
    ...
    <td class="value" colspan="3">
        <input name="explanation" style="width: 600px;"  datatype="*0-255" maxlength="255" />
      <span class="Validform_checktip">
                </span>
      ...
      <div style="width: 80px;">
        ...
        <a name="delTScRpRotherbillentryBtn[#index#]" id="delTScRpRotherbillentryBtn[#index#]" href="#"  onclick="clickDelTScRpRotherbillentryBtn('#index#');"></a>
            ...
            <td align="left" bgcolor="white">
                  <input name="tScRpRotherbillentryList[#index#].expName" maxlength="32" datatype="*"
                         onkeypress="keyDownInfo('#index#',event)"
                         onchange="clearExp(this)"
                         onblur="orderListStockBlur('#index#','expId','expName');" type="text" class="inputxt popup-select" style="width:120px;"/>
