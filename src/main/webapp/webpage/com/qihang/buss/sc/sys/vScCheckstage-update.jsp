...
<!--20160629页脚样式 -->
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="vScCheckstageController.do?doUpdate" tiptype="1">
					<input id="trantype" name="trantype" type="hidden" value="${vScCheckstagePage.trantype }">
					<input id="sonid" name="sonid" type="hidden" value="${vScCheckstagePage.sonid }">
					<input id="id" name="id" type="hidden" value="${vScCheckstagePage.id }">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="checkstate" name="checkstate" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${vScCheckstagePage.checkstate}'>
							<span class="Validform_checktip">
							</span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="billno" name="billno" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${vScCheckstagePage.billno}'>
							<span class="Validform_checktip">
							</span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="departmentname" name="departmentname" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${vScCheckstagePage.departmentname}'>
							<span class="Validform_checktip">
							</span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="billName" name="billName" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${vScCheckstagePage.billName}'>
							<span class="Validform_checktip">
							</span>
