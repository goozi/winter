...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" title="退货申请" action="tScDrpRstockbillController.do?doAdd" beforeSubmit="checkBillDate" saveTemp="true">
    ...
    <table cellpadding="0" cellspacing="1" class="formtable" style="position: absolute;z-index: 50;width: 100% ">
        <tr>
            ...
            <td class="value">
                <input id="itemName" name="itemName" type="text" style="width: 150px" class="inputxt <c:if test="${(!delearType eq 'ADealer') || (!delearType eq '')}">popup-select</c:if>" datatype="*" <c:if test="${delearType eq 'CDealer'}">readonly</c:if><c:if test="${delearType eq ''}">readonly</c:if>/>
      ...
      <tr>
        ...
        <td class="value">
          ...
          <td class="value">
              <input id="sonName" name="sonName" value="${sonName}" readonly type="text" style="width: 150px" class="inputxt" datatype="*" >
              <span class="Validform_checktip"> *</span>
      ...
      <tr>
        ...
        <td class="value" colspan="5">
            <input id="explanation" name="explanation" type="text" style="width: 60%" class="inputxt" />
            <span class="Validform_checktip"> </span>
