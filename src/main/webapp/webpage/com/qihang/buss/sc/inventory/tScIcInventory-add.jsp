...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table"
             action="tScIcInventoryController.do?doAdd" tiptype="1">
      <input id="id" name="id" type="hidden"
             value="${tScIcInventoryPage.id }">
      <input id="createName" name="createName" type="hidden"
             value="${tScIcInventoryPage.createName }">
      <input id="createBy" name="createBy" type="hidden"
             value="${tScIcInventoryPage.createBy }">
      <input id="createDate" name="createDate" type="hidden"
             value="${tScIcInventoryPage.createDate }">
      <input id="updateName" name="updateName" type="hidden"
             value="${tScIcInventoryPage.updateName }">
      <input id="updateBy" name="updateBy" type="hidden"
             value="${tScIcInventoryPage.updateBy }">
      <input id="updateDate" name="updateDate" type="hidden"
             value="${tScIcInventoryPage.updateDate }">
      <input id="itemId" name="itemId" type="hidden"
             value="${tScIcInventoryPage.itemId }">
      <input id="stockId" name="stockId" type="hidden"
             value="${tScIcInventoryPage.stockId }">
      <input id="count" name="count" type="hidden"
             value="${tScIcInventoryPage.count }">
