...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:1px;">
        <t:datagrid name="tScBegdataList" checkbox="true" fitColumns="false" title="应收初始化"
            ...
            <t:dgCol title="客户" field="itemID"  query="true" queryMode="single" dictionary="T_SC_Organization,id,name"
                     width="180"></t:dgCol>
            ...
            <t:dgCol title="部门" field="deptID" query="true"  queryMode="single" dictionary="T_SC_Department,id,Name"
                     width="120"></t:dgCol>
            <t:dgCol title="总金额" field="dallAmount" queryMode="single" width="120"></t:dgCol>
            <t:dgCol title="已收金额" field="dcheckAmount" hidden="false" queryMode="single" width="120"></t:dgCol>
            <t:dgCol title="未收金额" field="dunCheckAmount" hidden="false" queryMode="single" width="120"></t:dgCol>
            ...
            <t:dgToolBar title="编辑" icon="new-icon-edit" url="tScBegdataController.do?goUpdate"
            ...
            <t:dgToolBar title="打印" icon="new-icon-print" funname="CreateFormPage('应收初始化', '#tScBegdataList')"></t:dgToolBar>
...
<script src="webpage/com/qihang/buss/sc/init/tScBegdataList.js"></script>
