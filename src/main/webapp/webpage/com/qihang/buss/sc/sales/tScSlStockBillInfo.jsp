...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:1px;">
        <t:datagrid name="tScOrderList" checkbox="true" fitColumns="false" title="应收单"
                    actionUrl="tScSlStockbillController.do?datagridMain&itemId=${itemId}&ids=${ids}&ids2=${ids2}&sonId=${sonId}" idField="id" fit="true" queryMode="group">
            ...
            <t:dgCol title="执行金额" field="checkAmount"  queryMode="single" width="120"></t:dgCol>
        </t:datagrid>
    </div>
</div>
