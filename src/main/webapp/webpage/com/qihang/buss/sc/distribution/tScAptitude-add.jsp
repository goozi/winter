...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" title="资格审查" layout="table" action="tScAptitudeController.do?doAdd" tiptype="1" beforeSubmit="checkBillDate" saveTemp="true">
    ...
    <table  cellpadding="0" cellspacing="1" class="formtable" style="position: absolute;z-index: 50;width: 100% "/>
        <tr>
            ...
            <td class="value" style="width: 24%">
                <input id="itemIDName" name="distributor" type="text" style="width: 150px" class="inputxt popup-select" datatype="*"  <c:if test="${delearType eq 'CDealer'}">readonly</c:if>/>
            ...
            <td class="value">
                <input id="corperate" name="corperate" type="text" style="width: 150px" class="inputxt" maxlength="40"/>
                <span class="Validform_checktip"> </span>
            ...
            <td class="value">
                <input id="contact" name="contact" type="text" style="width: 150px" class="inputxt" maxlength="20" />
                <span class="Validform_checktip"></span>
        ...
        <tr>
            ...
            <td class="value">
                <input id="mobilePhone" name="mobilePhone" type="text" style="width: 150px" class="inputxt" datatype="m" ignore="ignore"/>
                <span class="Validform_checktip"></span>
            ...
            <td class="value">
                <input id="phone" name="phone" type="text" style="width: 150px" class="inputxt" datatype="po" ignore="ignore" />
                <span class="Validform_checktip"></span>
        ...
        <tr>
            ...
            <td class="value">
                <input id="regCapital" name="regCapital" type="text" onchange="checkRegCapital(this)"  style="width: 150px" class="inputxt" datatype="d"  ignore="ignore" maxlength="13" errorMsg="请填写正确的注册资金"/>
                <span class="Validform_checktip"></span>
            ...
            <td class="value" colspan="3">
                <input id="address" name="address" type="text" style="width: 575px" class="inputxt" maxlength="100"/>
                <span class="Validform_checktip"></span>
        ...
        <tr>
            ...
            <td class="value">
                <input id="economyKind" name="economyKind" type="text" style="width: 150px" class="inputxt" maxlength="40" />
                <span class="Validform_checktip"></span>
            ...
            <td class="value">
                <input id="trench" name="trench" type="text" style="width: 150px" class="inputxt" maxlength="100" />
                <span class="Validform_checktip"></span>
            ...
            <td class="value">
                <input id="itemName" name="itemName" type="text" style="width: 150px" class="inputxt" maxlength="100"/>
                <span class="Validform_checktip"> </span>
        ...
        <tr>
            ...
            <td class="value">
                <input id="planQty" name="planQty" type="text" style="width: 150px" class="inputxt" datatype="float" ignore="ignore"/>
                <span class="Validform_checktip"></span>
            ...
            <td class="value">
                <input id="trenchA" name="trenchA" type="text" style="width: 150px" class="inputxt" datatype="number" ignore="ignore"/>
                <span class="Validform_checktip"> </span>
            ...
            <td class="value">
                <input id="trenchB" name="trenchB" type="text" style="width: 150px" class="inputxt" datatype="number" ignore="ignore" />
                <span class="Validform_checktip"></span>
        ...
        <tr>
            ...
            <td class="value">
                <input id="trenchC" name="trenchC" type="text" style="width: 150px" class="inputxt" datatype="number" ignore="ignore"/>
                <span class="Validform_checktip"> </span>
            ...
            <td class="value">
                <input id="trenchO" name="trenchO" type="text" style="width: 150px" class="inputxt" datatype="number" ignore="ignore" />
                <span class="Validform_checktip"></span>
            ...
            <td class="value">
                <t:dictSelect field="eligibility" showDefaultOption="false" type="list" typeGroupCode="sf_01" extendJson="{'datatype':'*'}" defaultVal="0" hasLabel="false" title="是否合格经销商"></t:dictSelect>
                <span class="Validform_checktip">* </span>
        ...
        <tr>
            ...
            <td class="value">
                <input type="text" style="width: 150px" class="inputxt" value="${sonName}" readonly datatype="*"/>
            ...
            <td class="value" colspan="3">
                <input id="explanation" name="explanation" type="text" style="width: 575px" class="inputxt" maxlength="100" />
                <span class="Validform_checktip"></span>
