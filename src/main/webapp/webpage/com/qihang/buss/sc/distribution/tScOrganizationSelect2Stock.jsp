...
<div class="easyui-layout" fit="true">
    ...
    <div region="center" style="padding:1px;">
        <t:datagrid name="tScOrganizationList" checkbox="false" fitColumns="false" title="客户"
                    actionUrl="tScDrpStockbillController.do?datagridSelected&disable=0&deleted=0&isDealer=1" checkOnSelect="true" idField="id" fit="true" onLoadSuccess="loadsuccess"
