...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" beforeSubmit="checkName"
             action="tScFeeController.do?doAdd" tiptype="1">
      <input id="id" name="id" type="hidden"
             value="${tScFeePage.id }">
      <input id="createName" name="createName" type="hidden"
             value="${tScFeePage.createName }">
      <input id="createBy" name="createBy" type="hidden"
             value="${tScFeePage.createBy }">
      <input id="createDate" name="createDate" type="hidden"
             value="${tScFeePage.createDate }">
      <input id="updateName" name="updateName" type="hidden"
             value="${tScFeePage.updateName }">
      <input id="updateBy" name="updateBy" type="hidden"
             value="${tScFeePage.updateBy }">
      <input id="updateDate" name="updateDate" type="hidden"
             value="${tScFeePage.updateDate }">
      <input id="parentID" name="parentID" type="hidden"
             value="${parentID}">
      <input id="disabled" name="disabled" type="hidden"
             value="${tScFeePage.disabled }">
      <input id="deleted" name="deleted" type="hidden"
             value="${tScFeePage.deleted }">
      <input id="version" name="version" type="hidden"
             value="${tScFeePage.version }">
      <input id="level" name="level" type="hidden"
             value="${tScFeePage.level }">
      <input id="count" name="count" type="hidden"
             value="${tScFeePage.count }">
    ...
    <td class="value">
          <textarea style="width:13%;" class="inputxt" rows="2" id="note"
                    name="note"></textarea>
      <span class="Validform_checktip">
      </span>
