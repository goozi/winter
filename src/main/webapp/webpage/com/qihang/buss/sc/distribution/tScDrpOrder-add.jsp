...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" title="订货管理" tiptype="1" action="tScDrpOrderController.do?doAdd" beforeSubmit="checkBillDate" saveTemp="true">
      ...
      <input id="sumAmount" name="sumAmount"  type="hidden" value='[{"itemName":"taxAmountEx","mainItemId":"amount"}]'/>
  <table cellpadding="0" cellspacing="1" class="formtable" style="position: absolute;z-index: 50;width: 100% ">
      <tr>
          ...
          <td class="value" style="width: 24%">
              <input id="itemName" name="itemName" type="text" value="${itemName}" style="width: 150px" class="inputxt <c:if test="${(!delearType eq 'ADealer') || (!delearType eq '')}">popup-select</c:if>" datatype="*" <c:if test="${(delearType eq 'ADealer') || (delearType eq '')}">readonly</c:if>/>
      ...
      <tr>
        ...
        <td class="value">
          ...
          <td class="value">
              <input id="allAmount" name="allAmount" type="text" style="width:150px;background-color:rgb(226,226,226);" class="inputxt" readonly />
              <span class="Validform_checktip"></span>
      ...
      <tr>
          ...
          <td class="value" colspan="5">
              <input id="explanation" name="explanation" type="text" style="width: 1000px" class="inputxt" />
              <span class="Validform_checktip"></span>
  ...
  <tbody id="add_tScDrpOrderentry_table_template">
    ...
    <%--<td align="left" bgcolor="white">
     ...
     <%-- <td align="left" bgcolor="white">
      ...
      <td align="left" bgcolor="white">
          <input name="tScDrpOrderentryList[#index#].taxPriceEx" maxlength="32" type="text" class="inputxt"  style="width:120px;" />
          <label class="Validform_label" style="display: none;">单价</label>
      </td>
      <td align="left" bgcolor="white">
          <input name="tScDrpOrderentryList[#index#].taxAmountEx" maxlength="32" type="text" class="inputxt"  style="width:120px;" />
