...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table"
             action="tScIcInventoryBatchnoController.do?doAdd" tiptype="1">
      <input id="id" name="id" type="hidden"
             value="${tScIcInventoryBatchnoPage.id }">
      <input id="createName" name="createName" type="hidden"
             value="${tScIcInventoryBatchnoPage.createName }">
      <input id="createBy" name="createBy" type="hidden"
             value="${tScIcInventoryBatchnoPage.createBy }">
      <input id="createDate" name="createDate" type="hidden"
             value="${tScIcInventoryBatchnoPage.createDate }">
      <input id="updateName" name="updateName" type="hidden"
             value="${tScIcInventoryBatchnoPage.updateName }">
      <input id="updateBy" name="updateBy" type="hidden"
             value="${tScIcInventoryBatchnoPage.updateBy }">
      <input id="updateDate" name="updateDate" type="hidden"
             value="${tScIcInventoryBatchnoPage.updateDate }">
      <input id="count" name="count" type="hidden"
             value="${tScIcInventoryBatchnoPage.count }">
