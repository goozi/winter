    ...
    <script type="text/javascript">
        ...
        function toggleCenter(){
            if($("#centerBody").is(":hidden")){
                ...
                $("#tScPrcplyentry2_tablescrolldiv").height(southBodyHigh-25);
            } else {
                $("#centerBody").slideUp();
                $("#southBody").height(centerBodyHigh +southBodyHigh );
                $("#tScPrcplyentry2_tablescrolldiv").height(centerBodyHigh +southBodyHigh-25);
            }
        }
...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" title="调价政策单" layout="table" tiptype="1" action="tScPrcplyController.do?doAdd" beforeSubmit="checkBillDate" saveTemp="true">
    <div  class="panel-body layout-body" style="height: 20%">
        ...
        <input id="checkDate" name="checkDate" type="hidden" value="${tScPrcplyPage.checkDate }"/>
        ...
        <input id="tranType" name="tranType" type="hidden" value="353"/>
        ...
        <input name="billNo" value="${tScPrcplyPage.billNo}" type="hidden"/>
        ...
        <table cellpadding="0" cellspacing="1" class="formtable" style="width: 100%">
            <tr>
                ...
                <td class="value">
                    <input type="text" style="width: 150px" class="inputxt" value="${sonName}" readonly="readonly"/>
                    <input id="sonName" name="sonName" type="hidden" value="${sonName}" readonly="readonly"/>
                    <span class="Validform_checktip"></span>
            ...
            <tr>
                ...
                <td class="value" colspan="5">
                    <input id="explanation" style="width:600px;" class="inputxt" rows="6" name="explanation"/>
                    <span class="Validform_checktip"></span>
    ...
    <div class="panel-body layout-body" id="centerBody" style="height: 20%"></div>
    ...
    <div class="panel-body layout-body" id="southBody" style="height: 10%"></div>
</t:formvalid>
<!-- 添加 附表明细 模版 -->
    ...
    <tr>
        ...
        <td align="center" bgcolor="white">
            <div style="width: 80px;">
                <a name="addTScPrcplyentry2Btn[#index#]" id="addTScPrcplyentry2Btn[#index#]" href="#" onclick="clickAddEntryBtn2('#index#');"></a>
                <a name="delTScPrcplyentry2Btn[#index#]" id="delTScPrcplyentry2Btn[#index#]" href="#" onclick="clickDelEntryBtn2('#index#');"></a>
            </div>
        </td>
        ...
        <td align="left" bgcolor="white">
            <input name="tScPrcplyentry2List[#index#].begQty" maxlength="32" type="text" onblur="checkNum('#index#','qty','begQty');" class="inputxt"  style="width:65px;" value="0" datatype="numrange" />
            <label class="Validform_label" style="display: none;">数量段（从）</label>
        </td>
        <td align="left" bgcolor="white">
            <input name="tScPrcplyentry2List[#index#].endQty" maxlength="32" type="text" onblur="checkNum('#index#','qty','endQty');" class="inputxt"  style="width:65px;" value="0" datatype="numrange"  />
            <label class="Validform_label" style="display: none;">数量段（至）</label>
        </td>
        <td align="left" bgcolor="white">
            <input name="tScPrcplyentry2List[#index#].price" maxlength="32" type="text" onblur="checkNum('#index#','price','price');" class="inputxt"  style="width:70px;" datatype="numrange"  value="0" onchange="changePrice('#index#')"/>
            <label class="Validform_label" style="display: none;">原价</label>
        </td>
        <td align="left" bgcolor="white">
            <input name="tScPrcplyentry2List[#index#].newPrice" maxlength="32" type="text" onblur="checkNum('#index#','price','newPrice');" class="inputxt"  style="width:71px;" datatype="numrange" value="0" onchange="changePrice('#index#')" />
            <label class="Validform_label" style="display: none;">新价</label>
        </td>
        <td align="left" bgcolor="white">
            <input name="tScPrcplyentry2List[#index#].differPrice" maxlength="32" type="text" class="inputxt" readonly="readonly"  style="width:72px;background-color:rgb(226,226,226);" />
            <label class="Validform_label" style="display: none;">差价</label>
        </td>
        <td align="left" bgcolor="white">
            <input name="tScPrcplyentry2List[#index#].disCountRate" maxlength="32" type="text" class="inputxt" readonly="readonly"  style="width:72px;background-color:rgb(226,226,226);"/>
            <label class="Validform_label" style="display: none;">折扣率</label>
        </td>
        <td align="left" bgcolor="white">
            <input name="tScPrcplyentry2List[#index#].begDate" maxlength="20" type="text" class="Wdate" onClick="WdatePicker()"  style="width:80px;" datatype="*"  />
            <label class="Validform_label" style="display: none;">起始日期</label>
        </td>
        <td align="left" bgcolor="white">
            <input name="tScPrcplyentry2List[#index#].endDate" maxlength="20" type="text" class="Wdate" onClick="WdatePicker()"  style="width:80px;" datatype="*"  />
...
=======--%>
  ...
  <tr>
      ...
      <td align="left" bgcolor="white">
          <input name="tScPrcplyentry2List[#index#].begQty" maxlength="32" type="text" onblur="checkNum('#index#','qty','begQty');" class="inputxt"  style="width:65px;" value="0" datatype="d" />
          <label class="Validform_label" style="display: none;">数量段（从）</label>
      </td>
      <td align="left" bgcolor="white">
          <input name="tScPrcplyentry2List[#index#].endQty" maxlength="32" type="text" onblur="checkNum('#index#','qty','endQty');" class="inputxt"  style="width:65px;" value="0" datatype="d"  />
          <label class="Validform_label" style="display: none;">数量段（至）</label>
      </td>
      <td align="left" bgcolor="white">
          <input name="tScPrcplyentry2List[#index#].price" maxlength="32" type="text" onblur="checkNum('#index#','price','price');" class="inputxt"  style="width:70px;" datatype="num"  value="0" onchange="changePrice('#index#')"/>
          <label class="Validform_label" style="display: none;">原价</label>
      </td>
      <td align="left" bgcolor="white">
          <input name="tScPrcplyentry2List[#index#].newPrice" maxlength="32" type="text" onblur="checkNum('#index#','price','newPrice');" class="inputxt"  style="width:71px;" datatype="num" value="0" onchange="changePrice('#index#')" />
          <label class="Validform_label" style="display: none;">新价</label>
      </td>
      <td align="left" bgcolor="white">
          <input name="tScPrcplyentry2List[#index#].differPrice" maxlength="32" type="text" class="inputxt" readonly="readonly"  style="width:72px;background-color:rgb(226,226,226);" />
...
<!-- 页脚显示 -->
<div style="position: absolute;bottom: 0px;left:10px;width:80%" >
    ...
    <div style="width: 34%;display: inline;float: right" align="left">
