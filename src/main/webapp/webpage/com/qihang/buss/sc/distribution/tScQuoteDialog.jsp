...
<div class="easyui-layout" fit="true">
  ...
  <div region="center" style="padding:1px;">
    <t:datagrid name="tScQuoteList" checkbox="true"  fitColumns="false" title="销售报价单" actionUrl="tScQuoteController.do?datagridView${not empty checkState?'&checkState='.concat(checkState):''}${not empty customerId?'&customerId='.concat(customerId):''}" idField="entryId" fit="true" queryMode="group">
    ...
    $("#tScQuoteList").datagrid({
      ...
      onLoadSuccess: function (data) {
        if(data.rows.length > 0){
          mergeCellsByField("tScQuoteList", "billNo,date,empid,empName,deptid,deptName,inureDate,auditorName,auditDate,checkState,sonName,opt","id");
        }
