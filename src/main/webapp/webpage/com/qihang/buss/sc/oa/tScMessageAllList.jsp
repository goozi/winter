...
<div class="easyui-layout" fit="true">
  <div data-options="region:'west',title:'消息分类',split:true" style="width:200px;">
    <ul id="tt" class="easyui-tree"></ul>
  </div>
  <div region="center" style="padding:1px;">
      <iframe scrolling="no" marginwidth="0" marginheight="0" id="message" frameborder="0" style="width: 100%;height: 100%" src="tScMessageReceiveController.do?tScMessageReceive"></iframe>
  </div>
 </div>
