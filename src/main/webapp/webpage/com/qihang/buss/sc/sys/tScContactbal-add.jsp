...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table"
             action="tScContactbalController.do?doAdd" tiptype="1">
      <input id="id" name="id" type="hidden"
             value="${tScContactbalPage.id }">
      <input id="createName" name="createName" type="hidden"
             value="${tScContactbalPage.createName }">
      <input id="createBy" name="createBy" type="hidden"
             value="${tScContactbalPage.createBy }">
      <input id="createDate" name="createDate" type="hidden"
             value="${tScContactbalPage.createDate }">
      <input id="updateName" name="updateName" type="hidden"
             value="${tScContactbalPage.updateName }">
      <input id="updateBy" name="updateBy" type="hidden"
             value="${tScContactbalPage.updateBy }">
      <input id="updateDate" name="updateDate" type="hidden"
             value="${tScContactbalPage.updateDate }">
