...
<t:formvalid formid="formobj" dialog="true" title="发货单" usePlugin="password" layout="table" tiptype="1" action="tScDrpStockbillController.do?doAdd" beforeSubmit="checkBillDate" saveTemp="true">
  ...
  <table cellpadding="0" cellspacing="1" class="formtable" style="position: absolute;z-index: 50;width: 100% ">
      <tr>
          ...
          <td class="value">
              <input id="dealerName" name="dealerName" type="text" style="width: 150px" class="inputxt <c:if test="${!(delearType eq 'CDealer')}">popup-select</c:if>" datatype="*" <c:if test="${delearType eq 'CDealer'}">readonly</c:if>/>
      ...
      <tr>
          ...
          <td class="value">
              <input id="rStockName" name="rStockName" type="text" style="width: 150px" class="inputxt popup-select" />
              <span class="Validform_checktip"></span>
      ...
      <tr>
            ...
            <td class="value">
                <input id="freight" name="freight" type="text" style="width: 150px" class="inputxt" readonly />
                <span class="Validform_checktip"></span>
          ...
          <td class="value">
              <input id="accountName" name="accountName" type="text" style="width: 150px" class="inputxt popup-select"  />
              <span class="Validform_checktip"></span>
      ...
      <tr>
          ...
          <td class="value">
              <input id="weight" name="weight" type="text" style="width: 150px" class="inputxt" readonly />
              <span class="Validform_checktip"></span>
          ...
          <td class="value">
              <input id="allAmount" name="allAmount" type="text" style="width: 150px" class="inputxt" readonly />
              <span class="Validform_checktip"></span>
      ...
      <tr>
        ...
        <td class="value">
            <%--<t:dictSelect field="classIDSrc" id="classIDSrc" type="list" extendJson="{'readonly':'readonly'}" typeGroupCode="sf_01" hasLabel="false" title="源单类型"></t:dictSelect>--%>
            ...
            <label class="Validform_label" style="display: none;">源单类型</label>
              ...
              <td class="value">
                  <input id="sonName" name="sonName" type="text" style="width: 150px" class="inputxt" value="${sonName}" readonly>
                  <span class="Validform_checktip"></span>
      ...
      <tr>
          ...
          <td class="value" colspan="5">
              <input id="explanation" name="explanation" type="text" style="width: 600px" class="inputxt" />
              <span class="Validform_checktip"> </span>
...
<table style="display:none">
  ...
  <tr>
      ...
      <td align="left" bgcolor="white">
          <input name="tScDrpStockbillentryList[#index#].stockName" datatype="*" id="tScDrpStockbillentryList[#index#].stockName" maxlength="32" onkeypress="keyDownInfo('#index#','stock',event)" onblur="orderListStockBlur('#index#','stockID','stockName');" type="text" class="inputxt popup-select"  style="width:85px;" />
          <label class="Validform_label" style="display: none;">仓库</label>
      </td>
      <td align="left" bgcolor="white">
