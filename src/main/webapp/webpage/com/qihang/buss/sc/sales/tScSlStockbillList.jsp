...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tScSlStockbillList" checkbox="true" tranType="103" tableName="t_sc_sl_stockbill" beforeAccount="true" isSon="true" rowStyler="dgRowStyler"
              fitColumns="false" title="销售出库单" actionUrl="tScSlStockbillController.do?datagrid&isWarm=${isWarm}" scrollview="true" entityName="TScSlStockbillViewEntity"
              idField="id" fit="true" queryMode="group"  onLoadSuccess="onloadsuccess" onDblClick="goDetail">
      ...
      <t:dgCol title="客户"  field="itemName" autocomplete="true" query="true" queryMode="single"  width="160"></t:dgCol>
      <t:dgCol title="经办人id"  field="empId" hidden="true"  queryMode="single"  width="120"></t:dgCol>
      <t:dgCol title="经办人"  field="empName" autocomplete="true" query="true"  queryMode="single"  width="65"></t:dgCol>
      <t:dgCol title="部门id"  field="deptId" hidden="true"  queryMode="single"  width="120"></t:dgCol>
      <t:dgCol title="部门"  field="deptName" autocomplete="true" query="true"  queryMode="single"  width="65"></t:dgCol>
      ...
      <t:dgCol title="应收金额"  field="allAmount"    queryMode="single"  width="70"></t:dgCol>
      ...
      <t:dgCol title="客户是否可审核" hidden="true" field="isAllowAudit"  queryMode="single"  width="90"></t:dgCol>
      <t:dgCol title="商城单号"  field="mallorderid" hidden="true"     width="180"></t:dgCol>
      ...
      <t:dgCol title="制单人"  field="billerID"    queryMode="single"  width="65"></t:dgCol>
      <t:dgCol title="审核人"  field="checkerName"    queryMode="single"  width="65"></t:dgCol>
      <t:dgCol title="审核日期"  field="checkDate"  formatter="yyyy-MM-dd"  queryMode="single"  width="128"></t:dgCol>
      <t:dgCol title="审核状态"  field="checkState" query="true" replace="未审核_0,审核中_1,已审核_2"   queryMode="single"  width="65"></t:dgCol>
      ...
      <t:dgToolBar title="打印" icon="new-icon-print"
          ...
          <%--  <t:dgToolBar title="同步状态" icon="new-icon-syn"
                         funname="sysStockState"></t:dgToolBar>--%>
        </t:datagrid>
        </div>
       </div>
...
//     }
//     billId = selects[0].id;
     var checked = $("#tScSlStockbillList").datagrid("getSelections");
     if(checked.length == 0){
         tip("请选择一条数据");
         return;
