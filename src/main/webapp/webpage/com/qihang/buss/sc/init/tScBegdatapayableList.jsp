...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:1px;">
        <t:datagrid name="tScBegdataList" checkbox="true" fitColumns="false" title="应付初始化"
            ...
            <t:dgCol title="供应商" field="itemID"  query="true" queryMode="single" dictionary="T_SC_SUPPLIER,id,name"
                     width="180"></t:dgCol>
            <t:dgCol title="应付日期" field="rpDate" formatter="yyyy-MM-dd" queryMode="single" width="120"></t:dgCol>
            ...
            <t:dgCol title="已付金额" field="checkAmount" hidden="false" queryMode="single" width="120"></t:dgCol>
            <t:dgCol title="未付金额" field="unCheckAmount" hidden="false" queryMode="single" width="120"></t:dgCol>
...
<script src="webpage/com/qihang/buss/sc/init/tScBegdatapayableList.js"></script>
