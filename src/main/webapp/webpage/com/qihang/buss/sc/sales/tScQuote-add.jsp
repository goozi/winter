  ...
  <script type="text/javascript">
    ...
    $(document).ready(function () {
      ...
      $(".tabs-wrap").css('width', '100%');
        ...
        $.ajax({
            type: "get",
            url: "tScQuoteController.do?tScQuotecustomerList&id=${tScQuotePage.id}",
        ...
        $.ajax({
            type: "get",
            url: "tScQuoteController.do?tScQuoteitemsList&id=${tScQuotePage.id}",
            success:function(data){
                $("#southBody").html(data);
...
<t:formvalid formid="formobj" dialog="true" title="销售报价单" tableName="t_sc_quote" usePlugin="password" layout="table" tiptype="1" saveTemp="true"
             action="tScQuoteController.do?doAdd">
<div  class="panel-body layout-body" style="height: 80px">
    ...
    <input id="billNo" name="billNo" value="${tScQuotePage.billNo}" type="hidden" validType='t_sc_quote,billNo,id'/>
      ...
      <tr>
        ...
        <%--</td>--%>
          ...
          <td class="value" width="24%">
              ...
              <td class="value">
                  <input id="inureDate" name="inureDate" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()" datatype="*" />
                  <span class="Validform_checktip">*</span>
        ...
        <tr>
            ...
            <td class="value" colspan="3">
                ...
                <input id="explanation" name="explanation"   style="width: 72.5%" class="inputxt"  datatype="*1-126" ignore="ignore" />
                <span class="Validform_checktip"></span>
