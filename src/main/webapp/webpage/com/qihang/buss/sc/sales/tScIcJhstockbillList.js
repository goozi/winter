//作废功能
function cancelBill(){
    var selected = $("#tScIcJhstockbillList").datagrid("getSelections");
    ...
    var url = "tScIcJhstockbillController.do?cancelBill"
    ...
    $.ajax({
        ...
        success: function (data) {
            if(data.success){
                tip("作废成功");
                $("#tScIcJhstockbillList").datagrid("reload");
            }else{
                tip(data.msg);
            }
        }
...
function doDel(id,billNo,date){
    ...
    var url="tScIcJhstockbillController.do?doDel&id="+id
...
function enableBill(){
    ...
    var url = "tScIcJhstockbillController.do?enableBill"
...
function afterAudit(billId){
    var select = $("#tScIcJhstockbillList").datagrid("getSelected");
    var id = billId;
