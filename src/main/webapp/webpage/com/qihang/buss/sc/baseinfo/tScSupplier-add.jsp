...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" beforeSubmit="checkName()"
             action="tScSupplierController.do?doAdd" tiptype="1">
      <input id="id" name="id" type="hidden"
             value="${tScSupplierPage.id }">
      <input id="createName" name="createName" type="hidden"
             value="${tScSupplierPage.createName }">
      <input id="createBy" name="createBy" type="hidden"
             value="${tScSupplierPage.createBy }">
      <input id="createDate" name="createDate" type="hidden"
             value="${tScSupplierPage.createDate }">
      <input id="updateName" name="updateName" type="hidden"
             value="${tScSupplierPage.updateName }">
      <input id="updateBy" name="updateBy" type="hidden"
             value="${tScSupplierPage.updateBy }">
      <input id="updateDate" name="updateDate" type="hidden"
             value="${tScSupplierPage.updateDate }">
      <input id="parentID" name="parentID" type="hidden"
             value="${parentID }">
      <input id="level" name="level" type="hidden"
             value="${tScSupplierPage.level }">
      <input id="disabled" name="disabled" type="hidden"
             value="${tScSupplierPage.disabled }">
      <input id="deleted" name="deleted" type="hidden"
             value="${tScSupplierPage.deleted }">
      <input id="version" name="version" type="hidden"
             value="${tScSupplierPage.version }">
      <input id="count" name="count" type="hidden"
             value="${tScSupplierPage.count }">
  ...
  <table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
      ...
      <tr>
          ...
          <td class="value">
              <t:dictSelect field="typeID" type="list"
                            typeGroupCode="SC_SUPPLIER_TYPE"
                            defaultVal="${tScSupplierPage.typeID}" hasLabel="false"
                            title="供应商分类"></t:dictSelect>
      <span class="Validform_checktip">
      </span>
      ...
      <span class="Validform_checktip">
              ...
              <td class="value">
                  <t:dictSelect field="city" type="list"
                                ...
                                defaultVal="${tScSupplierPage.city}" hasLabel="false"
      ...
      <span class="Validform_checktip">
              ...
              <td class="value">
                  <t:dictSelect field="regionID" type="list"
                                ...
                                defaultVal="${tScSupplierPage.regionID}" hasLabel="false"
          ...
          <tr>
              ...
              <td class="value">
                  <t:dictSelect field="bank" type="list"
                                ...
                                defaultVal="${tScSupplierPage.bank}" hasLabel="false"
          ...
          <tr>
              ...
              <td class="value">
                  <t:dictSelect field="trade" type="list"
                                ...
                                defaultVal="${tScSupplierPage.trade}" hasLabel="false"
    ...
    <td class="value" colspan="5">
          <textarea style="width:80%;" class="inputxt" rows="2" id="note"
                    name="note"
              datatype="*1-80" ignore=ignore
                  ></textarea>
      <span class="Validform_checktip">
