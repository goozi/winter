...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1"
             action="tScIcitemController.do?doAdd" beforeSubmit="checkMsg">
      <input id="id" name="id" type="hidden"
             value="${tScIcitemPage.id }">
      <input id="createName" name="createName" type="hidden"
             value="${tScIcitemPage.createName }">
      <input id="createBy" name="createBy" type="hidden"
             value="${tScIcitemPage.createBy }">
      <input id="createDate" name="createDate" type="hidden"
             value="${tScIcitemPage.createDate }">
      <input id="updateName" name="updateName" type="hidden"
             value="${tScIcitemPage.updateName }">
      <input id="updateBy" name="updateBy" type="hidden"
             value="${tScIcitemPage.updateBy }">
      <input id="updateDate" name="updateDate" type="hidden"
             value="${tScIcitemPage.updateDate }">
      <input id="parentID" name="parentID" type="hidden"
             value="${parentID }">
      <input id="level" name="level" type="hidden"
             value="${tScIcitemPage.level }">
      <input id="disabled" name="disabled" type="hidden"
             value="${tScIcitemPage.disabled }">
  ...
  <table cellpadding="0" cellspacing="1" class="formtable" style="position: absolute;z-index: 50;width: 100%">
      <tr>
        ...
        <td class="value" width="23%">
          ...
          <td class="value" width="24%">
              <input id="shortName" name="shortName" type="text" style="width: 150px" class="inputxt"  readonly="true"
                      >
      <span class="Validform_checktip">
                </span>
      ...
      <tr>
          ...
          <td class="value">
              <input id="model" name="model" type="text" style="width: 150px" class="inputxt" datatype="*1-126" ignore="ignore"
                      >
      <span class="Validform_checktip">
                </span>
          ...
          <td class="value">
              <input id="costPrice" name="costPrice" type="text" style="width: 150px" class="inputxt" datatype="num"
                      >
                <span class="Validform_checktip">*
                </span>
          ...
          <td class="value">
              <t:dictSelect field="itemType" type="list" showDefaultOption="false"
                            typeGroupCode="SC_STOCK_TYPE" hasLabel="false" defaultVal="0001"
                            title="存货类型" extendJson="{datatype:*}"></t:dictSelect>
      <span class="Validform_checktip">*
                </span>
      ...
      <tr>
          ...
          <td class="value">
              <t:dictSelect field="track" type="list" showDefaultOption="false"
                            typeGroupCode="SC_PRICE_METHOD" hasLabel="false" defaultVal="0002"
                            title="计价方法" extendJson="{datatype:*}"></t:dictSelect>
               <span class="Validform_checktip">*
                </span>
          ...
          <td class="value">
              <t:dictSelect field="iskfPeriod" type="list"
                            ...
                            title="按保质期管理" showDefaultOption="false" defaultVal="N"></t:dictSelect>
      <span class="Validform_checktip">
                </span>
          ...
          <td class="value">
              <input id="kfPeriod" name="kfPeriod" type="text" style="width: 150px" class="inputxt" readonly="true"
                      >
      <span class="Validform_checktip">
                </span>
      ...
      <tr>
          ...
          <td class="value">
              <t:dictSelect field="kfDateType" type="list"
                            ...
                            title="保质期类型" extendJson="{'disabled':'true','style':'background-color:rgb(226, 226, 226)'}"></t:dictSelect>
                <span class="Validform_checktip">
                </span>
          ...
          <td class="value">
              <t:dictSelect field="batchManager" type="list"
                            typeGroupCode="sf_yn" hasLabel="false" defaultVal="N" showDefaultOption="false"
      ...
      <span class="Validform_checktip">*
          ...
          <td class="value">
              <input id="weight" name="weight" type="text" style="width: 150px" class="inputxt" datatype="num" ignore="ignore"
                      >
                <span class="Validform_checktip">
                </span>
      ...
      <span class="Validform_checktip">
          ...
          <td class="value">
              <input id="supplierName" name="supplierName" type="text" style="width: 150px" class="inputxt popup-select"
                      >
      <span class="Validform_checktip">
                </span>
          ...
          <td class="value">
              <input id="factory" name="factory" type="text" style="width: 150px" class="inputxt" datatype="*1-126" ignore="ignore"
                      >
      <span class="Validform_checktip">
                </span>
      ...
      <tr>
          ...
          <td class="value">
              <input id="producingPlace" name="producingPlace" type="text" style="width: 150px" class="inputxt" datatype="*1-126" ignore="ignore"
                      >
      <span class="Validform_checktip">
                </span>
          ...
          <td class="value">
              <input id="taxRateIn" name="taxRateIn" type="text" style="width: 150px" class="inputxt" datatype="num" ignore="ignore" value="${tScIcitemPage.taxRateIn }"
                      >
      <span class="Validform_checktip">
                </span>
          ...
          <td class="value">
              <input id="taxRateOut" name="taxRateOut" type="text" style="width: 150px" class="inputxt"  datatype="num" ignore="ignore" value="${tScIcitemPage.taxRateOut}"
                      >
      <span class="Validform_checktip">
                </span>
      ...
      <span class="Validform_checktip">*
          ...
          <td class="value">
              <input id="shortNumber" name="shortNumber" type="text" style="width: 150px" class="inputxt" datatype="*1-40" ignore="ignore"
                      >
      <span class="Validform_checktip">
                </span>
          ...
          <td class="value">
              <input id="cultureNo" name="cultureNo" type="text" style="width: 150px" class="inputxt" datatype="*1-126" ignore="ignore"
                      >
      <span class="Validform_checktip">
                </span>
      ...
      <tr>
          ...
          <td class="value"colspan="3">
              <input id="note" name="note" type="text"  class="inputxt" style="width: 80%"
                      >
      <span class="Validform_checktip">
                </span>
  ...
  <div style="width: auto;height: 200px;margin-top: 120px;">
    ...
    <t:tabs id="tt" iframe="false" tabPosition="top" fit="false">
      <t:tab href="tScIcitemController.do?tScItemPriceList&id=${tScIcitemPage.id}"
             icon="icon-search" title="单位价格表" id="tScItemPrice"></t:tab>
      <t:tab href="tScIcitemController.do?tScItemPhotoList&id=${tScIcitemPage.id}"
             icon="icon-search" title="商品图片表" id="tScItemPhoto"></t:tab>
    </t:tabs>
  </div>
</t:formvalid>
<!-- 添加 附表明细 模版 -->
<table style="display:none">
  ...
  <tr>
        ...
        <div style="width: 80px;background-color: white;">
          ...
          <td align="left">
              <t:dictSelect field="tScItemPriceList[#index#].unitType"
                            ...
                            title="单位类型" extendJson="{'datatype':'*'}" width="125px"></t:dictSelect>
    ...
    <%--datatype="/^[0-9]+\.?[0-9]*$/" message="111"--%>
            ...
            <td align="left">
                  <input name="tScItemPriceList[#index#].defaultCG"
...
>
            ...
            <td align="left">
                  <input name="tScItemPriceList[#index#].defaultXS" maxlength="32"
                         type="checkbox"  style="width:120px;" value="1"
>
              <label class="Validform_label" style="display: none;">默认销售单位</label>
            </td>
            <td align="left">
                  <input name="tScItemPriceList[#index#].defaultCK"  style="width:120px;"
                         type="checkbox" value="1"
>
              <label class="Validform_label" style="display: none;">默认仓存单位</label>
            </td>
              <td align="left">
                  <input name="tScItemPriceList[#index#].lsRetailPrice" maxlength="32" onchange="setAllAmount(this);"
            ...
            <td align="left">
                  <input name="tScItemPriceList[#index#].xsLatestPrice" maxlength="32"
                         ...
                         onblur="checkPrecision('#index#','xsLatestPrice')"
                         readonly="readonly"
                      >
  ...
  <tr>
    <td align="center">
      ...
      <td align="center"><div style="width: 80px;margin-top: -5px"><a name="addLineTScItemPhotoBtn[#index#]" id="addLineTScItemPhotoBtn[#index#]" href="#"  class="easyui-linkbutton" data-options="iconCls:'icon-add'" plain="true" onclick="clickAddTScItemPhotoBtn('#index#');"></a><a name="delLineTScItemPhotoBtn[#index#]" id="delLineTScItemPhotoBtn[#index#]" href="#"  class="easyui-linkbutton" data-options="iconCls:'icon-remove'"  plain="true" onclick="clickDelTScItemPhotoBtn('#index#');"></a></div></td>
            <td align="left">
