...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                type: "get",
                url: "tScIcJhstockbillController.do?tScIcJhstockbillentry1List&id=${tScIcJhstockbillPage.id}",
            ...
            $.ajax({
                type: "get",
                url: "tScIcJhstockbillController.do?tScIcJhstockbillentry2List&id=${tScIcJhstockbillPage.id}",
                success:function(data){
                    $("#southBody").html(data);
            ...
            function toggleSouth(){
                if($("#southBody").is(":hidden")){
                    ...
                    $("#tScIcJhstockbillentry1_tablescrolldiv").height(centerBodyHigh-50);
                } else {
                    $("#southBody").slideUp();
...
<input id="defaultTaxRate" type="hidden" value="${taxRate}">
<input id="isCheckNegative" type="hidden" value="${isCheckNegative}">
<input id="tempRecoveryExt" type="hidden" value="doTempRecoveryExt">
<t:formvalid formid="formobj" styleClass="fullForm" dialog="true" title="采购换货单" usePlugin="password" layout="table" tiptype="1"
             beforeSubmit="checkPriceIsZero" saveTemp="true"
             action="tScIcJhstockbillController.do?doAdd">
<div  class="panel-body layout-body" style="height: 20%">
    ...
    <table cellpadding="0" cellspacing="1" class="formtable" style="z-index: 50;position: absolute">
      ...
      <span class="Validform_checktip">
        ...
        <tr>
                <%--<td align="right">--%>
                <%--<label class="Validform_label">换货差额:</label>--%>
                <%--</td>--%>
                <%--<td class="value">--%>
                ...
                <%--<span class="Validform_checktip">--%>
                <%--</span>--%>
                <%--<label class="Validform_label" style="display: none;">换货差额</label>--%>
                <%--</td>--%>
      ...
      <span class="Validform_checktip">
                ...
                <label class="Validform_label" style="display: none;">结算账户</label>
                    ...
                    <%--</td>--%>
                    <%--<td class="value">--%>
                        <%--<input id="classIDSrc" name="classIDSrc" type="text" style="width: 150px" class="inputxt"--%>
                               <%--readonly="readonly"--%>
                                <%-->--%>
      <%--<span class="Validform_checktip">--%>
                <%--</span>--%>
...
<table style="display:none">
    ...
    <tr>
        ...
        <td align="center" bgcolor="white">
            <div style="width: 80px;"><a name="addTScOrderentryBtn[#index#]"
                                                         ...
                                                         plain="true"
                                                         onclick="clickAddEntryBtn('#index#','tScIcJhstockbillentry1');"></a><a
                    ...
                    onclick="clickDelTScOrderentryBtn('#index#','tScIcJhstockbillentry2');"></a></div>
        </td>
        ...
        <td align="left" bgcolor="white">
            <t:dictSelect width="70" field="tScIcJhstockbillentry1List[#index#].kfDateType_" extendJson="{disabled:disabled}"
                          type="list"
    ...
    <tr>
        ...
        <td align="left" bgcolor="white">
            <t:dictSelect width="70" field="tScIcJhstockbillentry2List[#index#].kfDateType_" extendJson="{disabled:disabled}"
                          type="list"
                          typeGroupCode="SC_DURA_DATE_TYPE" defaultVal="" hasLabel="false"
                          title="保质期类型"></t:dictSelect>
            <label class="Validform_label" style="display: none;">保质期类型</label>
