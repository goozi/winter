...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1"
             action="tScNoticeController.do?doAdd">
    <input id="id" name="id" type="hidden"
           value="${tScNoticePage.id }">
    <input id="createName" name="createName" type="hidden"
           value="${tScNoticePage.createName }">
    <input id="createBy" name="createBy" type="hidden"
           value="${tScNoticePage.createBy }">
    <input id="updateName" name="updateName" type="hidden"
           value="${tScNoticePage.updateName }">
    <input id="updateBy" name="updateBy" type="hidden"
           value="${tScNoticePage.updateBy }">
    <input id="updateDate" name="updateDate" type="hidden"
           value="${tScNoticePage.updateDate }">
    <input id="createDate" name="createDate" type="hidden"
           value="${tScNoticePage.createDate }">
    <input id="issuance" name="issuance" type="hidden"
           value="${tScNoticePage.issuance }">
    <input id="issuanceDate" name="issuanceDate" type="hidden"
           value="${tScNoticePage.issuanceDate }">
    <table cellpadding="0" cellspacing="1" class="formtable">
        ...
        <tr>
            ...
            <td class="value">
                <%--<input class="easyui-combobox" id="type" style="width:155px;" name="type" data-options="valueField:'id',textField:'text',required:false,editable:false,url:'tScNoticeController.do?loadTypeInfo'">--%>
                <%--<t:dictSelect field="type" type="list" id="type"  extendJson="{'datatype':'*'}" divClass="width:155px;"
                              dictTable="T_SC_VIEW_DEPART" dictField="id" dictText="departname" hasLabel="false"
                              title="公告类型"></t:dictSelect>--%>
                    <t:dictSelect field="type" type="list"
                                  typeGroupCode="noteType" extendJson="{'datatype':'*'}"
                                  defaultVal="${tScNoticesPage.type}" hasLabel="false"
        ...
        <tr>
            ...
            <td class="value">
                    <%--<t:dictSelect field="userId" type="list" typeGroupCode="" hasLabel="false"
                                  title="通知人员"></t:dictSelect>--%>
              <%--  <select class="easyui-combotree" id="userId" style="width:155px;"  datatype="select1"
                        data-optons="cascadeCheck:true,multiple:true" name="userId" ></select>--%>
...
    ['Maximize', 'ShowBlocks','-','Source','-','Undo','Redo']]" value=""></t:ckeditor>
    ...
    <div style="width: auto;height: 100px;">
        ...
        <t:tabs id="tt" iframe="false" tabPosition="top" fit="false">
            <t:tab href="tScNoticeController.do?tScNoticeFileList&id=${tScNoticePage.id}"
                   icon="icon-search" title="公告通知附件表" id="tScNoticeFile"></t:tab>
        </t:tabs>
    </div>
</t:formvalid>
<!-- 添加 附表明细 模版 -->
<table style="display:none;height: 100px;" >
    ...
    <tr>
        ...
        <td align="left">
            <input type="hidden" id="tScNoticeFileList[#index#].fileName"
                   name="tScNoticeFileList[#index#].fileName"/>
            <a target="_blank" id="ScNoticeFileList[#index#].fileName_href">未上传</a>
            <br>
