...
<div class="easyui-layout" fit="true">
    ...
    <div region="center" style="padding: 1px;">
        <t:datagrid sortName="createDate" sortOrder="desc" name="tablePropertyList" title="打印配置" entityName="CgFormHeadEntity"
                    fitColumns="false" actionUrl="printController.do?datagrid" idField="id" fit="true"
                    queryMode="group" checkbox="true">
            <t:dgCol title="common.id" field="id" hidden="true"></t:dgCol>
            <t:dgCol title="table.type" field="jformType" replace="single.table_1,master.table_2,slave.table_3"></t:dgCol>
            ...
            <t:dgCol title="sync.db" field="isDbSynch" replace="has.sync_Y,have.nosync_N" style="background:red;_N"
                     hidden="true"></t:dgCol>
            ...
            <%--<t:dgFunOpt exp="isDbSynch#eq#Y&&jformType#ne#3" funname="addbytab(id,content)"--%>
                        <%--title="form.template"></t:dgFunOpt>--%>
            <%--<t:dgFunOpt exp="isDbSynch#eq#Y&&jformType#ne#3" funname="addlisttab(tableName,content)"--%>
                        <%--title="function.test"></t:dgFunOpt>--%>
            <t:dgFunOpt exp="isDbSynch#eq#Y&&jformType#ne#3" funname="printTemplate(id)"
                        title="打印模板"></t:dgFunOpt>
            <t:dgFunOpt exp="isDbSynch#eq#Y&&jformType#ne#3" funname="addlisttab(tableName,content)"
                        title="打印预览"></t:dgFunOpt>
            <%--<t:dgFunOpt exp="isDbSynch#eq#Y&&jformType#ne#3" funname="popMenuLink(tableName,content)"--%>
                        <%--title="config.place"></t:dgFunOpt>--%>
            <%--<t:dgToolBar title="create.form" icon="icon-add" width="900" height="600"--%>
                         <%--url="cgFormHeadController.do?addorupdate" funname="addForm"></t:dgToolBar>--%>
            <%--<t:dgToolBar title="edit.form" icon="icon-edit" width="900" height="600"--%>
                         <%--url="cgFormHeadController.do?addorupdate" funname="updateForm"></t:dgToolBar>--%>
            <%--<t:dgToolBar title="custom.button" icon="icon-edit" url="cgformButtonController.do?cgformButton"--%>
                         <%--funname="cgFormButton"></t:dgToolBar>--%>
            <%--<t:dgToolBar title="js.custom" icon="icon-edit" url="cgformEnhanceJsController.do?addorupdate"--%>
                         <%--funname="enhanceJs" windowType="dialog"></t:dgToolBar>--%>
            <%--<t:dgToolBar title="sql.custom" icon="icon-edit" url="cgformButtonSqlController.do?addorupdate"--%>
                         <%--funname="cgFormButtonSql" windowType="dialog"></t:dgToolBar>--%>
            <%--<t:dgToolBar title="form.export" icon="icon-putout" url="cgformSqlController.do?doMigrateOut"--%>
                         <%--funname="doMigrateOut"></t:dgToolBar>--%>
            <%--<t:dgToolBar title="form.import" icon="icon-put" url="cgformSqlController.do?inSqlFile"--%>
            ...
            <%--<t:dgToolBar title="code.generate" icon="icon-add" url="generateController.do?gogenerate" funname="generate"--%>
                         <%--windowType="dialog"></t:dgToolBar>--%>
            <%--<t:dgToolBar title="form.generate" icon="icon-add" url="cgformTransController.do?trans"--%>
                         <%--funname="addToData"></t:dgToolBar>--%>
        </t:datagrid></div>
</div>

<script type="text/javascript">
    function printTemplate(id) {
        addOneTab('打印模板', "printController.do?printTemplateList&formid=" + id);
    }
