...
<div class="easyui-layout" fit="true">
  <div region="center" style="padding: 1px;">
    <t:datagrid name="cgformFtlList" title="表单模板列表"
      ...
      <t:dgConfOpt title="激活" url="cgformFtlController.do?active&id={id}&formId=${formid}" exp="ftlStatus#eq#0"
                   message="确认激活模板"/>
      <t:dgConfOpt title="取消激活" url="cgformFtlController.do?cancleActive&id={id}&formId=${formid}" exp="ftlStatus#eq#1"
                   message="确认取消激活"/>
      <t:dgFunOpt funname="ftleditor(id,cgformName)" title="模板编辑"></t:dgFunOpt>
      <t:dgToolBar title="Word模板上传" icon="icon-add" url="cgformFtlController.do?addorupdate&cgformId=${formid}"
                   funname="add" windowType="dialog">
      </t:dgToolBar>
    </t:datagrid>
  </div>
</div>
