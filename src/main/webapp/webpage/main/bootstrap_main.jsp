...
<div class="container-fluid"><a class="brand" href="http://www.qihang.com" target="_blank"><t:mutiLang langKey="common.platform"/> &nbsp;&nbsp;<span class="slogan"></span></a>
...
<ul class="footer-links">
	<li style="display: inline;">&copy; <t:mutiLang langKey="common.copyright"/><a href="http://www.qihang.com" title="WINTER Framework -0.2">WINTER Framework -0.2</a></li>
	<li style="display: inline;">&nbsp;<t:mutiLang langKey="common.copyright"/><t:mutiLang langKey="common.browser"/>:<a title="WINTER Framework -0.2" href="http://www.qihang.com">WINTER Framework -0.2</a></li>
</ul>
</div>
</footer>
