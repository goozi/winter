...
<!-- 顶部-->
<div region="north" border="false" title=" WINTER Framework -0.2"
     style="BACKGROUND: #E6E6FA; height: 85px; padding: 1px; overflow: hidden;">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td align="left" style="vertical-align: text-bottom;padding-left: 70px;padding-top: 5px;">
        <img src="plug-in/login/images/logo.png" height="48" width="64">
        <!--
            <img src="plug-in/login/images/toplogo.png" width="550" height="52" alt="">-->
        <%--<div style="position: absolute; top: 75px; left: 33px;">WINTER Framework <span style="letter-spacing: -1px;">-0.2</span>--%>
        <%--</div>--%>
      </td>
          ...
          <tr>
            ...
            <div id="layout_north_zxMenu" style="width: 100px; display: none;">
              ...
              <div onclick="exit('loginController.do?logout','<t:mutiLang langKey="common.exit.confirm"/>',1);">
                <t:mutiLang langKey="common.exit"/></div>
            </div>
          </tr>
        </table>
      </td>
...
<div region="south" border="false" style="height: 25px; overflow: hidden;">
  <div align="center" style="color: #CC99FF; padding-top: 2px">&copy;
    <t:mutiLang langKey="common.copyright"/>
        <span class="tip">
            <a href="http://www.qihang.com" title=" WINTER Framework -0.2"> WINTER Framework -0.2</a>
            <t:mutiLang langKey="common.copyright"/>:
            <a href="#" title=" WINTER Framework -0.2">WINTER Framework -0.2</a>
        </span>
  </div>
</div>
