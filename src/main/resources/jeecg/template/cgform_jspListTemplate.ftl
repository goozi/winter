...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:1px;">
        <t:datagrid name="${entityName?uncap_first}List" checkbox="true" fitColumns="false" title="${ftl_description}"
                    actionUrl="${entityName?uncap_first}Controller.do?datagrid" idField="id" fit="true"
                    queryMode="group">
        <#list columns as po>
    ...
    $(document).ready(function () {
        ...
        $("#${entityName?uncap_first}List").datagrid({
            ...
            onDblClickRow: function (rowIndex, rowData) {
                url = '${entityName?uncap_first}Controller.do?goUpdate' + '&load=detail&id=' + rowData.id;
