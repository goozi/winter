package com.qihang.winter.web.graphreport.controller;
...
import com.qihang.winter.web.graphreport.service.core.GraphReportServiceI;
...
public class GraphReportController extends BaseController {
  ...
  public void list(String id, HttpServletRequest request,
    ...
    String html = viewEngine.parseTemplate("/com/qihang/winter/web/graphreport/engine/core/graphreportlist.ftl", cgReportMap);
    try {
