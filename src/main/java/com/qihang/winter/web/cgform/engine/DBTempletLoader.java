package com.qihang.winter.web.cgform.engine;

import com.qihang.winter.web.cgform.common.CgAutoListConstant;
import com.qihang.winter.web.cgform.common.FormHtmlUtil;
...
public class DBTempletLoader implements TemplateLoader {
  ...
  public static final String TEMPLET = "com/qihang/winter/web/cgform/engine/jform.ftl";
  public static final String TEMPLET_ONE_MANY = "com/qihang/winter/web/cgform/engine/jformunion.ftl";
  //生成输入框匹配内容
  ...
  private Object getObject(String name) throws IOException {
    ...
    if (name.lastIndexOf(".ftl") == -1) {//判断是否为include的模板
      ...
      if (head.getJformType() == CgAutoListConstant.JFORM_TYPE_MAIN_TALBE && (cgformFtlEntity!=null?!cgformFtlEntity.get("EDITOR_TYPE").equals("04"):true)) {
      ...
      if (cgformFtlEntity != null) {
        ...
        if(!cgformFtlEntity.get("EDITOR_TYPE").equals("04")) {
...
//				e.printStackTrace();
//			}
//			LogUtil.info("current path :" + path);
//		}
