package com.qihang.winter.web.cgform.controller.cgformftl;
...
import com.qihang.winter.web.cgform.common.OfficeHtmlUtil;
  ...
  public AjaxJson saveWordFiles(HttpServletRequest request,
    ...
    try {
      ...
      for (Map.Entry<String, MultipartFile> entity : fileMap.entrySet()) {
        ...
        htmlStr = officeHtml.doHtml(htmlStr,cgformFtl.getEditorType());
        ...
        StringBuilder jslib = new StringBuilder("");
        SysThemesEnum sysThemesEnum = SysThemesUtil.getSysTheme(request);
        jslib.append("<head>\n");
        jslib.append("<script type=\"text/javascript\" src=\"plug-in/jquery/jquery-1.8.3.js\"></script>\n");
        jslib.append("<script type=\"text/javascript\" src=\"plug-in/tools/dataformat.js\"></script>\n");
        jslib.append("<link rel=\"stylesheet\" type=\"text/css\" href=\"plug-in/accordion/css/accordion.css\">\n");
//			jslib.append("<link id=\"easyuiTheme\" rel=\"stylesheet\" href=\"plug-in/easyui/themes/"+cssTheme+"/easyui.css\" type=\"text/css\"></link>\n");
        jslib.append(SysThemesUtil.getEasyUiTheme(sysThemesEnum));
        jslib.append("<link rel=\"stylesheet\" href=\"plug-in/easyui/themes/icon.css\" type=\"text/css\"></link>\n");
        jslib.append("<link rel=\"stylesheet\" type=\"text/css\" href=\"plug-in/accordion/css/icons.css\">\n");
        jslib.append("<script type=\"text/javascript\" src=\"plug-in/easyui/jquery.easyui.min.1.3.2.js\"></script>\n");
        jslib.append("<script type=\"text/javascript\" src=\"plug-in/easyui/locale/zh-cn.js\"></script>\n");
        jslib.append("<script type=\"text/javascript\" src=\"plug-in/tools/syUtil.js\"></script>\n");
        jslib.append("<script type=\"text/javascript\" src=\"plug-in/My97DatePicker/WdatePicker.js\"></script>\n");
        jslib.append("<script type=\"text/javascript\" src=\"plug-in/clipboard/ZeroClipboard.js\"></script>\n");
//			jslib.append("<link rel=\"stylesheet\" href=\"plug-in/tools/css/common.css\" type=\"text/css\"></link>\n");
        jslib.append(SysThemesUtil.getCommonTheme(sysThemesEnum));
//			jslib.append("<script type=\"text/javascript\" src=\"plug-in/lhgDialog/lhgdialog.min.js\"></script>\n");
        jslib.append(SysThemesUtil.getLhgdialogTheme(sysThemesEnum));
        jslib.append(StringUtil.replace("<script type=\"text/javascript\" src=\"plug-in/tools/curdtools_{0}.js\"></script>\n", "{0}", lang));
        jslib.append("<script type=\"text/javascript\" src=\"plug-in/tools/easyuiextend.js\"></script>\n");
        jslib.append("<script type=\"text/javascript\" src=\"plug-in/Validform/js/Validform_v5.3.1_min_zh-cn.js\"></script>");
        jslib.append("<script type=\"text/javascript\" src=\"plug-in/Validform/js/Validform_Datatype_zh-cn.js\"></script>");
        jslib.append("<script type=\"text/javascript\" src=\"plug-in/Validform/js/datatype_zh-cn.js\"></script>");
        jslib.append("<script type=\"text/javascript\" src=\"plug-in/Validform/plugin/passwordStrength/passwordStrength-min.js\"></script>");
//			if("metro".equals(cssTheme)){
//				jslib.append("<link id=\"easyuiTheme\" rel=\"stylesheet\" href=\"plug-in/easyui/themes/"+cssTheme+"/main.css\" type=\"text/css\"></link>\n");
//			}
        jslib.append(SysThemesUtil.getEasyUiMainTheme(sysThemesEnum));
        jslib.append("</head>\n");
        htmlStr = htmlStr.replaceAll("<body\\s*>", jslib.toString()
                + "<body>");
        // js plugin start
