package com.qihang.winter.web.cgform.service.impl.build;
...
//    if (data.containsKey(DataBaseConstant.SYS_SON_TYPE_TABLE)) {
//      data.put(DataBaseConstant.SYS_SON_TYPE_TABLE, ResourceUtil.getUserSystemData(DataBaseConstant.SYS_SON_TYPE));
//    }
  }
  ...
  private String replaceExtendSqlSysVar(String sql) {
    sql = sql.replace("{" + DataBaseConstant.SYS_USER_CODE_TABLE + "}", ResourceUtil.getUserSystemData(DataBaseConstant.SYS_USER_CODE))
            ...
            .replace("{" + DataBaseConstant.SYS_SON_ID_TABLE + "}", ResourceUtil.getUserSystemData(DataBaseConstant.SYS_SON_ID))
