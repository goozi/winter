...
import com.qihang.winter.web.system.dao.repair.RepairDao;
import com.qihang.winter.web.system.pojo.base.*;
import com.qihang.winter.web.system.service.RepairService;
import com.qihang.winter.web.demo.entity.test.CKEditorEntity;
import com.qihang.winter.web.demo.entity.test.CourseEntity;
import com.qihang.winter.web.demo.entity.test.JeecgDemoCkfinderEntity;
import com.qihang.winter.web.demo.entity.test.JeecgJdbcEntity;
import com.qihang.winter.web.demo.entity.test.JeecgMatterBom;
...
import com.qihang.winter.web.demo.entity.test.TSStudent;
import com.qihang.winter.web.demo.entity.test.TeacherEntity;
...
//		approver.setTSDepart(eiu);
	...
	private void repairMenu() {
		...
		TSIcon folder = commonDao.findByProperty(TSIcon.class, "iconName",
				"文件夹").get(0);
		LogUtil.info(defaultIcon.getIconPath());
