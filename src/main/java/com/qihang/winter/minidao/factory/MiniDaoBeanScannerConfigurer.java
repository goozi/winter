package com.qihang.winter.minidao.factory;
...
public class MiniDaoBeanScannerConfigurer implements BeanDefinitionRegistryPostProcessor {
	 ...
	 */
	private Class<? extends Annotation> annotation = com.qihang.winter.minidao.annotation.MiniDao.class;
	/**
	 * Map key类型
	 */
	...
	private void registerGenericBaseCommonDao(BeanDefinitionRegistry registry) {
		...
		genericBaseCommonDaofinition.setBeanClass(com.qihang.winter.minidao.hibernate.dao.impl.GenericBaseCommonDao.class);
	...
	private void registerRequestProxyHandler(BeanDefinitionRegistry registry) {
		...
		jdbcDaoProxyDefinition.setBeanClass(com.qihang.winter.minidao.aop.MiniDaoHandler.class);
