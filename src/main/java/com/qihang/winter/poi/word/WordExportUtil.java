 ...
 */
package com.qihang.winter.poi.word;
...
public final class WordExportUtil {
    ...
    public static XWPFDocument exportWord07(String url, Map<String, Object> map) throws Exception {
        return new com.qihang.winter.poi.word.parse.ParseWord07().parseWord(url, map);
    }
    ...
    public static void exportWord07(XWPFDocument document, Map<String, Object> map)
                                                                                   throws Exception {
        new com.qihang.winter.poi.word.parse.ParseWord07().parseWord(document, map);
    }
