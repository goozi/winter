...
public final class PoiElUtil {
    ...
    private static Boolean isTrue(String[] keys, Map<String, Object> map) throws Exception {
        ...
        if (keys.length == 3) {
            ...
            return com.qihang.winter.poi.util.PoiFunctionUtil.isTrue(first, keys[1], second);
        }
    ...
    private static Object formatNumber(String text, Map<String, Object> map) throws Exception {
        ...
        return innerEval(
            replacinnerEvalue(text,
                com.qihang.winter.poi.util.PoiFunctionUtil.formatNumber(PoiPublicUtil.getParamsValue(key[0], map), key[1])),
            map);
    }
    ...
    private static Object formatDate(String text, Map<String, Object> map) throws Exception {
        ...
        return innerEval(
            replacinnerEvalue(text,
                com.qihang.winter.poi.util.PoiFunctionUtil.formatDate(PoiPublicUtil.getParamsValue(key[0], map), key[1])), map);
    }
    ...
    private static Object length(String text, Map<String, Object> map) throws Exception {
        ...
        return innerEval(replacinnerEvalue(text, com.qihang.winter.poi.util.PoiFunctionUtil.length(val)), map);
    }
