        ...
        try {
            ...
            for (Field field : fields) {
                ...
                if (isCollection(field.getType())) {
                    com.qihang.winter.poi.excel.annotation.ExcelCollection collection = field.getAnnotation(com.qihang.winter.poi.excel.annotation.ExcelCollection.class);
    ...
    public static Method getMethod(String name, Class<?> pojoClass) throws Exception {
        ...
        try {
            ...
            method = pojoClass.getMethod(
                getMethodName.toString().replace(com.qihang.winter.poi.excel.entity.vo.PoiBaseConstants.GET, com.qihang.winter.poi.excel.entity.vo.PoiBaseConstants.IS),
                new Class[] {});
        }
        return method;
    }
    ...
    public static boolean isNotUserExcelUserThis(List<String> exclusionsList, Field field,
        ...
        if (field.getAnnotation(com.qihang.winter.poi.excel.annotation.ExcelIgnore.class) != null) {
            boo = true;
                   ...
                   && field.getAnnotation(com.qihang.winter.poi.excel.annotation.ExcelCollection.class) != null
                   && isUseInThis(field.getAnnotation(com.qihang.winter.poi.excel.annotation.ExcelCollection.class).name(), targetId)
                   && (exclusionsList == null || !exclusionsList.contains(field.getAnnotation(
                       com.qihang.winter.poi.excel.annotation.ExcelCollection.class).name()))) {
            boo = false;
        } else if (boo
                   && field.getAnnotation(com.qihang.winter.poi.excel.annotation.Excel.class) != null
                   && isUseInThis(field.getAnnotation(com.qihang.winter.poi.excel.annotation.Excel.class).name(), targetId)
                   && (exclusionsList == null || !exclusionsList.contains(field.getAnnotation(
                       com.qihang.winter.poi.excel.annotation.Excel.class).name()))) {
            boo = false;
        } else if (boo
                   && field.getAnnotation(com.qihang.winter.poi.excel.annotation.ExcelEntity.class) != null
                   && isUseInThis(field.getAnnotation(com.qihang.winter.poi.excel.annotation.ExcelEntity.class).name(), targetId)
                   && (exclusionsList == null || !exclusionsList.contains(field.getAnnotation(
                       com.qihang.winter.poi.excel.annotation.ExcelEntity.class).name()))) {
            boo = false;
        }
        return boo;
    }
