 ...
 */
package com.qihang.winter.poi.excel.view;
...
@Controller(com.qihang.winter.poi.excel.entity.vo.TemplateWordConstants.JEECG_TEMPLATE_WORD_VIEW)
public class JeecgTemplateWordView extends AbstractView {
    ...
    protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
        ...
        if (model.containsKey(com.qihang.winter.poi.excel.entity.vo.TemplateWordConstants.FILE_NAME)) {
            codedFileName = (String) model.get(com.qihang.winter.poi.excel.entity.vo.TemplateWordConstants.FILE_NAME) + ".docx";
        }
        if (isIE(request)) {
        ...
        XWPFDocument document = com.qihang.winter.poi.word.WordExportUtil.exportWord07(
            ...
            (Map<String, Object>) model.get(com.qihang.winter.poi.excel.entity.vo.TemplateWordConstants.MAP_DATA));
