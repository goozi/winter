...
public class SheetHandler extends DefaultHandler {
    ...
    public void endElement(String uri, String localName, String name) throws SAXException {
        ...
        if (com.qihang.winter.poi.excel.entity.enmus.CellValueType.TElement.equals(type)) {
            ...
            rowlist.add(curCol, new SaxReadCellEntity(com.qihang.winter.poi.excel.entity.enmus.CellValueType.String, value));
            curCol++;
            ...
            if (com.qihang.winter.poi.excel.entity.enmus.CellValueType.Date.equals(type)) {
                ...
                rowlist.add(curCol, new SaxReadCellEntity(com.qihang.winter.poi.excel.entity.enmus.CellValueType.Date, date));
            } else if (com.qihang.winter.poi.excel.entity.enmus.CellValueType.Number.equals(type)) {
                BigDecimal bd = new BigDecimal(value);
                rowlist.add(curCol, new SaxReadCellEntity(com.qihang.winter.poi.excel.entity.enmus.CellValueType.Number, bd));
