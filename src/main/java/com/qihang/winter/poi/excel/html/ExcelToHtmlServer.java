package com.qihang.winter.poi.excel.html;
...
public class ExcelToHtmlServer {
    ...
    public String printPage() {
        try {
            ...
            new com.qihang.winter.poi.excel.html.helper.StylerHelper(wb, out, sheetNum, cssRandom);
            if (completeHTML) {
                out.format("</head>%n");
                out.format("<body>%n");
            }
    ...
    private void printSheetContent(Sheet sheet) {
        ...
        com.qihang.winter.poi.excel.html.helper.MergedRegionHelper mergedRegionHelper = new com.qihang.winter.poi.excel.html.helper.MergedRegionHelper(sheet);
        com.qihang.winter.poi.excel.html.helper.CellValueHelper cellValueHelper = new com.qihang.winter.poi.excel.html.helper.CellValueHelper(wb, cssRandom);
        out.format("<tbody>%n");
