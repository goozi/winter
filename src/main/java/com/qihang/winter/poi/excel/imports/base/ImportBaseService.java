...
public class ImportBaseService {
    ...
    public ExcelVerifyEntity getImportVerify(Field field) {
        com.qihang.winter.poi.excel.annotation.ExcelVerify verify = field.getAnnotation(com.qihang.winter.poi.excel.annotation.ExcelVerify.class);
        if (verify != null) {
    ...
    public void getAllExcelField(String targetId, Field[] fields,
                                 ...
                                 List<com.qihang.winter.poi.excel.entity.params.ExcelCollectionParams> excelCollection, Class<?> pojoClass,
     ...
     * @param collection
     */
    private void additionalCollectionName(com.qihang.winter.poi.excel.entity.params.ExcelCollectionParams collection) {
     ...
     * @throws Exception
     */
    public String getSaveExcelUrl(com.qihang.winter.poi.excel.entity.ImportParams params, Class<?> pojoClass) throws Exception {
        String url = "";
