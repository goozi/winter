...
public abstract class ExcelExportBase extends ExportBase {
    ...
    protected com.qihang.winter.poi.excel.entity.enmus.ExcelType type          = com.qihang.winter.poi.excel.entity.enmus.ExcelType.HSSF;

    private Map<Integer, Double>       statistics    = new HashMap<Integer, Double>();

    private static final DecimalFormat DOUBLE_FORMAT = new DecimalFormat("######0.00");

    private com.qihang.winter.poi.excel.export.styler.IExcelExportStyler excelExportStyler;
    ...
    public int createCells(Drawing patriarch, int index, Object t,
                           List<com.qihang.winter.poi.excel.entity.params.ExcelExportEntity> excelParams, Sheet sheet, Workbook workbook,
     ...
     * @throws Exception
     */
    public void createImageCell(Drawing patriarch, com.qihang.winter.poi.excel.entity.params.ExcelExportEntity entity, Row row, int i,
    ...
    private int createIndexCell(Row row, int index, com.qihang.winter.poi.excel.entity.params.ExcelExportEntity excelExportEntity) {
        if (excelExportEntity.getName().equals("序号")
            && excelExportEntity.getFormat().equals(com.qihang.winter.poi.excel.entity.vo.PoiBaseConstants.IS_ADD_INDEX)) {
     ...
     * @param entity
     */
    private void addStatisticsData(Integer index, String text, com.qihang.winter.poi.excel.entity.params.ExcelExportEntity entity) {
     ...
     * @return
     */
    public int getFieldWidth(List<com.qihang.winter.poi.excel.entity.params.ExcelExportEntity> excelParams) {
    ...
    private Map<Integer, int[]> getMergeDataMap(List<com.qihang.winter.poi.excel.entity.params.ExcelExportEntity> excelParams) {
        ...
        for (com.qihang.winter.poi.excel.entity.params.ExcelExportEntity entity : excelParams) {
            ...
            if (entity.getList() != null) {
                for (com.qihang.winter.poi.excel.entity.params.ExcelExportEntity inner : entity.getList()) {
     ...
     * @return
     */
    public CellStyle getStyles(boolean needOne, com.qihang.winter.poi.excel.entity.params.ExcelExportEntity entity) {
     ...
     * @param styles 
     */
    public void mergeCells(Sheet sheet, List<com.qihang.winter.poi.excel.entity.params.ExcelExportEntity> excelParams, int titleHeight) {
        Map<Integer, int[]> mergeMap = getMergeDataMap(excelParams);
        com.qihang.winter.poi.util.PoiMergeCellUtil.mergeCells(sheet, mergeMap, titleHeight);
    }

    public void setCellWith(List<com.qihang.winter.poi.excel.entity.params.ExcelExportEntity> excelParams, Sheet sheet) {
        int index = 0;
        for (int i = 0; i < excelParams.size(); i++) {
            if (excelParams.get(i).getList() != null) {
                List<com.qihang.winter.poi.excel.entity.params.ExcelExportEntity> list = excelParams.get(i).getList();
    ...
    public void setExcelExportStyler(com.qihang.winter.poi.excel.export.styler.IExcelExportStyler excelExportStyler) {
        this.excelExportStyler = excelExportStyler;
    }

    public com.qihang.winter.poi.excel.export.styler.IExcelExportStyler getExcelExportStyler() {
