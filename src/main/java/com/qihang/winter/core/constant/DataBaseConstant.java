...
public interface DataBaseConstant {
   ...
   * 数据-所属監管单位ID
   */
  public static final String SYS_SON_ID = "sonIdSup";
  /**
   * 数据-所属監管单位ID
   */
  public static final String SYS_SON_ID_TABLE = "son_id_sup";

  /**
   * 数据-所属主体单位
   */
  public static final String SYS_COM_ID = "sonId";
  /**
   * 数据-所属主体单位
   */
  public static final String SYS_COM_ID_TABLE = "son_id";
