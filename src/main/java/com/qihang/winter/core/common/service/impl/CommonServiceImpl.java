package com.qihang.winter.core.common.service.impl;

import com.qihang.winter.core.common.dao.ICommonDao;
...
public class CommonServiceImpl implements CommonService {
    ...
    public <T> List<T> findByProperty(Class<T> entityClass,
        ...
        return commonDao.findByProperty(entityClass, propertyName, value, mode);
    }
    ...
    public <T> List<T> findListbySql(String query, Class<T> entity) {
        return commonDao.findListbySql(query, entity);
    }
    ...
    public <T> List<T> getAutoList(Autocomplete autocomplete) {
        ...
        for (String searchField : autocomplete.getSearchField().split(",")) {
            ...
            sb.append("  or " + searchField + " like '%"
                    + autocomplete.getTrem() + "%' or " +
                    (ResourceUtil.getConfigByName("jdbc.url.jeecg").equals("mysql") ? "" : "dbo.") +
                    "FB_GetChineseSpell(" + searchField + ") like '%" + autocomplete.getTrem() + "%'");
        }
