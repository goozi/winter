package com.qihang.winter.core.common.dao.impl;

import com.qihang.winter.core.annotation.JeecgEntityTitle;
import com.qihang.winter.core.common.dao.IGenericBaseCommonDao;
import com.qihang.winter.core.common.dao.jdbc.JdbcDao;
import com.qihang.winter.core.common.exception.BusinessException;
import com.qihang.winter.core.common.hibernate.qbc.CriteriaQuery;
import com.qihang.winter.core.common.hibernate.qbc.*;
import com.qihang.winter.core.common.model.common.DBTable;
import com.qihang.winter.core.common.model.json.DataGridReturn;
import com.qihang.winter.core.util.LogUtil;
import com.qihang.winter.core.util.MyBeanUtils;
import com.qihang.winter.core.util.ToEntityUtil;
...
public abstract class GenericBaseCommonDao<T, PK extends Serializable>
  ...
  public <T> List<T> findByProperty(Class<T> entityClass,
    ...
    if (mode) {
      se = Restrictions.like(propertyName, value.toString(), MatchMode.START);
    } else {
      se = Restrictions.eq(propertyName, value.toString());
    }
    return (List<T>) createCriteria(entityClass,
            se).list();
  }
   ...
   * @return
   */
  public <T> List<T> findListbySql(String sql, Class<T> entity) {
    Query querys = getSession().createSQLQuery(sql).addEntity(entity);
    return querys.list();
  }
