 ...
 *
 */
public class TScRpExpensesapplyPage implements java.io.Serializable {
	/**保存-费用申报单明细*/
	private List<TScRpExpensesapplyentryEntity> tScRpExpensesapplyentryList = new ArrayList<TScRpExpensesapplyentryEntity>();
	public List<TScRpExpensesapplyentryEntity> getTScRpExpensesapplyentryList() {
		return tScRpExpensesapplyentryList;
	}
	public void setTScRpExpensesapplyentryList(List<TScRpExpensesapplyentryEntity> tScRpExpensesapplyentryList) {
		this.tScRpExpensesapplyentryList = tScRpExpensesapplyentryList;
	}
