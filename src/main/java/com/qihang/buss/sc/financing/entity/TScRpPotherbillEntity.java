 ...
 */
@Entity
@Table(name = "t_sc_rp_potherbill", schema = "")
@SuppressWarnings("serial")
public class TScRpPotherbillEntity implements java.io.Serializable {
	/**主键*/
	private String id;
	/**创建人名称*/
  ...
  @Excel(name="分支机构")
	...
	@Column(name ="ITEMCLASSID",nullable=true,length=3)
	...
	@Column(name ="CLASSIDSRC",nullable=true,length=3)
	...
	@Transient
	public String getClassIdSrcName() {
		return classIdSrcName;
	}

	public void setClassIdSrcName(String classIdSrcName) {
		this.classIdSrcName = classIdSrcName;
	}
}
