 ...
 */
@Entity
@Table(name = "T_SC_IC_Bal", schema = "")
@SuppressWarnings("serial")
public class TScIcBalEntity implements java.io.Serializable {
	/**主键*/
	...
	/**本期收入辅助数量*/
	@Excel(name="本期收入辅助数量")
	private java.math.BigDecimal secReceive;
	/**本期发出数量*/
	@Excel(name="本期发出数量")
	private java.math.BigDecimal send;
	/**本期发出数量*/
	@Excel(name="本期发出辅助数量")
	private java.math.BigDecimal secSend;
	/**本年累计收入数量*/
	@Excel(name="本年累计收入数量")
	...
	public java.math.BigDecimal getSecReceive(){
	 ...
	 */
	public void setSecReceive(java.math.BigDecimal secReceive){
	...
	public java.math.BigDecimal getSecSend(){
		return this.secSend;
	}
	 ...
	 */
	public void setSecSend(java.math.BigDecimal secSend){
