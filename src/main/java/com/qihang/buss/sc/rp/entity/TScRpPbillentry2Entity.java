 ...
 */
@Entity
@Table(name = "t_sc_rp_pbillentry2", schema = "")
@SuppressWarnings("serial")
public class TScRpPbillentry2Entity implements java.io.Serializable {
	/**id*/
	...
	/**
	 *方法: 取得java.math.BigDecimal
	 *@return: java.math.BigDecimal  源单已付金额
	 */
	...
	/**
	 *方法: 设置java.math.BigDecimal
	 *@param: java.math.BigDecimal  源单已付金额
	 */
	...
	/**
	 *方法: 取得java.math.BigDecimal
	 *@return: java.math.BigDecimal  源单未付金额
	 */
	...
	/**
	 *方法: 设置java.math.BigDecimal
	 *@param: java.math.BigDecimal  源单未付金额
	 */
