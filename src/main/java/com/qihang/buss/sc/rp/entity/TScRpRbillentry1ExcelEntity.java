 ...
 */
@Entity
@Table(name = "T_SC_RP_RBillEntry1", schema = "")
@SuppressWarnings("serial")
public class TScRpRbillentry1ExcelEntity implements java.io.Serializable {
	/**主键*/
	private String id;
	/**创建人名称*/
	...
	private TScRpRbillExcelEntity entryToMain;

	@ManyToOne(fetch = FetchType.EAGER)
	@JoinColumn(name = "fid",referencedColumnName = "ID")
	public TScRpRbillExcelEntity getEntryToMain() {
		return entryToMain;
	}

	public void setEntryToMain(TScRpRbillExcelEntity entryToMain) {
