 ...
 */
@Entity
@Table(name = "T_SC_RP_PBill", schema = "")
@SuppressWarnings("serial")
public class TScRpPbillExcelEntity implements java.io.Serializable {
    /**
     * 主键
     */
    private String id;
     ...
     * 收款类型
     */
    @Excel(name = "付款类型",dicCode = "SC_BillType_Pay")
    ...
    Set<TScRpPbillentry1ExcelEntity> mainToEntry;

    @OneToMany(mappedBy = "entryToMain",cascade = CascadeType.ALL)
    @OrderBy("findex asc")
    public Set<TScRpPbillentry1ExcelEntity> getMainToEntry() {
        return mainToEntry;
    }

    public void setMainToEntry(Set<TScRpPbillentry1ExcelEntity> mainToEntry) {
