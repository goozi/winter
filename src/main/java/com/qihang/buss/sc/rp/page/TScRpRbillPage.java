 ...
 *
 */
public class TScRpRbillPage implements java.io.Serializable {
	/**保存-结算表*/
	private List<TScRpRbillentry1Entity> tScRpRbillentry1List = new ArrayList<TScRpRbillentry1Entity>();
	public List<TScRpRbillentry1Entity> getTScRpRbillentry1List() {
		return tScRpRbillentry1List;
	}
	public void setTScRpRbillentry1List(List<TScRpRbillentry1Entity> tScRpRbillentry1List) {
		this.tScRpRbillentry1List = tScRpRbillentry1List;
	}
	/**保存-应收表*/
	private List<TScRpRbillentry2Entity> tScRpRbillentry2List = new ArrayList<TScRpRbillentry2Entity>();
	public List<TScRpRbillentry2Entity> getTScRpRbillentry2List() {
		return tScRpRbillentry2List;
	}
	public void setTScRpRbillentry2List(List<TScRpRbillentry2Entity> tScRpRbillentry2List) {
		this.tScRpRbillentry2List = tScRpRbillentry2List;
	}
