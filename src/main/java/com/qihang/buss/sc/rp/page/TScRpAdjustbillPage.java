 ...
 *
 */
public class TScRpAdjustbillPage implements java.io.Serializable {
	/**保存-应收调账从表*/
	private List<TScRpAdjustbillentryEntity> tScRpAdjustbillentryList = new ArrayList<TScRpAdjustbillentryEntity>();
	public List<TScRpAdjustbillentryEntity> getTScRpAdjustbillentryList() {
		return tScRpAdjustbillentryList;
	}
	public void setTScRpAdjustbillentryList(List<TScRpAdjustbillentryEntity> tScRpAdjustbillentryList) {
		this.tScRpAdjustbillentryList = tScRpAdjustbillentryList;
	}
