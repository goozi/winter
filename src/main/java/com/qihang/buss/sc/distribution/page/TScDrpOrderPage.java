 ...
 *
 */
public class TScDrpOrderPage implements java.io.Serializable {
	/**保存-订单管理*/
	private List<TScDrpOrderentryEntity> tScDrpOrderentryList = new ArrayList<TScDrpOrderentryEntity>();
	public List<TScDrpOrderentryEntity> getTScDrpOrderentryList() {
		return tScDrpOrderentryList;
	}
	public void setTScDrpOrderentryList(List<TScDrpOrderentryEntity> tScDrpOrderentryList) {
		this.tScDrpOrderentryList = tScDrpOrderentryList;
	}
