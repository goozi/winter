...
public class TScItemPriceEntity implements java.io.Serializable {
    /**
     * 主键
     */
     ...
     * 单位类型
     */
    @Excel(name = "单位类型",dicCode = "SC_UNIT_TYPE")
     ...
     */
    @Excel(name = "默认采购单位" )
    private java.lang.Integer defaultCG;
    /**
     * 默认销售单位
     */
    @Excel(name = "默认销售单位")
    private java.lang.Integer defaultXS;
    /**
     * 默认仓存单位
     */
    @Excel(name = "默认仓存单位")
    private java.lang.Integer defaultCK;
    /**
     * 默认生产单位
     */
    private java.lang.Integer defaultSC;
    /**
     * 采购限价
     */
    @Excel(name = "采购限价")
    private java.math.BigDecimal cgLimitPrice;
    /**
     * 最近采购价
     */
    @Excel(name = "最近采购价")
    private java.math.BigDecimal cgLatestPrice;
    /**
     * 采购单价
     */
    @Excel(name = "采购单价")
     ...
     */
    @Excel(name = "一级采购价")
    private java.math.BigDecimal cgPrice1;
    /**
     * 二级采购价
     */
    @Excel(name = "二级采购价")
    private java.math.BigDecimal cgPrice2;
    /**
     * 三级采购价
     */
    @Excel(name = "三级采购价")
    private java.math.BigDecimal cgPrice3;
    /**
     * 销售限价
     */
    @Excel(name = "销售限价")
     ...
     */
    @Excel(name = "最近销售价 ")
    private java.math.BigDecimal xsLatestPrice;
    /**
     * 销售单价
     */
    @Excel(name = "销售单价")
    private java.math.BigDecimal xsPrice;
    /**
     * 一级销售价
     */
    @Excel(name = "一级销售价")
    private java.math.BigDecimal xsPrice1;
    /**
     * 二级销售价
     */
    @Excel(name = "二级销售价")
    private java.math.BigDecimal xsPrice2;
    /**
     * 三级销售价
     */
    @Excel(name = "三级销售价")
    private java.math.BigDecimal xsPrice3;
    /**
     * 会员价
     */
    @Excel(name = "会员价")
    private java.math.BigDecimal lsMemberPrice;
    /**
     * 零售价
     */
    @Excel(name = "零售价 ")
    private java.math.BigDecimal lsRetailPrice;
    /**
     * 版本号
     */
...
//    @Column(name = "UNITID", nullable = true, length = 32)
    ...
    public java.lang.Integer getDefaultCG() {
     ...
     */
    public void setDefaultCG(java.lang.Integer defaultCG) {
    ...
    public java.lang.Integer getDefaultXS() {
     ...
     */
    public void setDefaultXS(java.lang.Integer defaultXS) {
    ...
    public java.lang.Integer getDefaultCK() {
     ...
     */
    public void setDefaultCK(java.lang.Integer defaultCK) {
    ...
    public java.lang.Integer getDefaultSC() {
     ...
     */
    public void setDefaultSC(java.lang.Integer defaultSC) {
