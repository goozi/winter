 ...
 */
@Entity
@Table(name = "T_SC_DAILY_FILE", schema = "")
@SuppressWarnings("serial")
public class TScDailyFileEntity implements java.io.Serializable {
	/**主键*/
	private String id;
	/**创建人名称*/
	...
	private TScDailyEntity parentFileObj;
	...
	public TScDailyEntity getParentFileObj() {
		return parentFileObj;
	}

	public void setParentFileObj(TScDailyEntity parentFileObj) {
