 ...
 */
@Entity
@Table(name = "T_SC_NEWS", schema = "")
@SuppressWarnings("serial")
public class TScNewsEntity implements java.io.Serializable {
	/**主键*/
	private String id;
	/**创建人名称*/
	 ...
	 */
	@Column(name ="ISSUANCE_DATE",nullable=true,length=32)
