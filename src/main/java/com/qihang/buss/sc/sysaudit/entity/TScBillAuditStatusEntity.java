 ...
 * @date 2016-10-11 17:55:23
 * @version V1.0   
 *
 */
@Entity
@Table(name = "t_sc_bill_audit_status", schema = "")
@SuppressWarnings("serial")
public class TScBillAuditStatusEntity implements java.io.Serializable {
	/**主键*/
	...
	private Integer cancellation;//作废标记
