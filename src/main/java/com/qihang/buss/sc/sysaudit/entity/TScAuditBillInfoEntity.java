 ...
 * @date 2016-10-21 18:15:22
 * @version V1.0   
 *
 */
@Entity
@Table(name = "t_sc_audit_bill_info", schema = "")
@SuppressWarnings("serial")
public class TScAuditBillInfoEntity implements java.io.Serializable {
	/**主键*/
	 ...
	 *@return: java.lang.Integer  旧状态值
	 */
	@Column(name ="OLDSTATE",nullable=true,length=1)
	...
	/**
	 *方法: 取得java.lang.Integer
	 *@return: java.lang.Integer  新状态值
	 */
	@Column(name ="NEWSTATE",nullable=true,length=1)
