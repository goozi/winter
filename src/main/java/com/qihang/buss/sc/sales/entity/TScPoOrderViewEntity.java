 ...
 */
@Entity
@Table(name = "v_sc_po_order", schema = "")
@SuppressWarnings("serial")
public class TScPoOrderViewEntity implements java.io.Serializable {
	/**主键*/
	private String id;
	/**创建人名称*/
  ...
  @Excel(name="摘要")
	...
	private Integer isStock;//是否已被调用

	private String isKFPeriod;//是否保质期
	private String batchManager;//是否批号
	private String kfDateType;//保质期类型
	private Double kfPeriod;//保质期
	...
	private String tranTypeName;//单据类型名称
	...
	private String entryStockId;//仓库id
	...
	private Date jhDate;//收货日期
	private Integer freeGifts;//赠品标记
	private Double stockQty;//收货数量
	private String note;//备注

	private String basicUnitName;//基本单位
	private String secUnitId;//复制单位id
	...
	private Double basicCoefficient;//基本换算率
	...
	@Column(name ="jhDate",nullable=true)
	...
	@Column(name ="stockQty",nullable=true)
	...
	public Double getKfPeriod() {
		return kfPeriod;
	}

	public void setKfPeriod(Double kfPeriod) {
