 ...
 */
@Entity
@Table(name = "T_SC_PO_StockBill", schema = "")
@SuppressWarnings("serial")
public class TScPoStockBillExcelEntity implements java.io.Serializable {
    /**主键*/
    private String id;
    ...
    List<TScPoStockBillentryExcelEntity> mainToEntry;

    @OneToMany(mappedBy = "entryToMain",cascade = CascadeType.ALL)
    public List<TScPoStockBillentryExcelEntity> getMainToEntry() {
        return mainToEntry;
    }

    public void setMainToEntry(List<TScPoStockBillentryExcelEntity> mainToEntry) {
