 ...
 */
@Entity
@Table(name = "v_sc_sl_stockbill_info", schema = "")
public class TScSlStockBillInfoView implements java.io.Serializable{
    ...
    private String itemId;//客户id
    private String itemName;//客户名称
