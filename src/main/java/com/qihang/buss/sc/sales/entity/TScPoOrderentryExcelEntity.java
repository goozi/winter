...
public class TScPoOrderentryExcelEntity implements java.io.Serializable {
	/**主键*/
	private String id;
	/**创建人名称*/
	...
	private TScPoOrderExcelEntity entryToMain;

	@ManyToOne(fetch = FetchType.EAGER)
	@JoinColumn(name = "fid",referencedColumnName = "ID")
	public TScPoOrderExcelEntity getEntryToMain() {
		return entryToMain;
	}

	public void setEntryToMain(TScPoOrderExcelEntity entryToMain) {
