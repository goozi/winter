...
public class TScIcJhstockbillExcelEntity implements java.io.Serializable {
    /**主键*/
    private String id;
...
//    }
    ...
    List<TScIcJhstockbillentry2ExcelEntity> mainToEntry2;

    @OneToMany(mappedBy = "entryToMain",cascade = CascadeType.ALL)
    public List<TScIcJhstockbillentry2ExcelEntity> getMainToEntry2() {
        return mainToEntry2;
    }

    public void setMainToEntry2(List<TScIcJhstockbillentry2ExcelEntity> mainToEntry2) {
