...
public class TScPoStockBillentryExcelEntity implements java.io.Serializable {
	/**主键*/
	private String id;
	/**创建人名称*/
	...
	private TScPoStockBillExcelEntity entryToMain;

	@ManyToOne(fetch = FetchType.EAGER)
	@JoinColumn(name = "fid",referencedColumnName = "ID")
	public TScPoStockBillExcelEntity getEntryToMain() {
		return entryToMain;
	}

	public void setEntryToMain(TScPoStockBillExcelEntity entryToMain) {
