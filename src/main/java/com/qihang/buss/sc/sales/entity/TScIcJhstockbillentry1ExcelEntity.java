 ...
 */
@Entity
@Table(name = "T_SC_IC_JHStockBillEntry1", schema = "")
@SuppressWarnings("serial")
public class TScIcJhstockbillentry1ExcelEntity implements java.io.Serializable {
	/**主键*/
	private String id;
	/**创建人名称*/
	...
	private TScIcJhstockbillExcelEntity entryToMain;

	@ManyToOne(fetch = FetchType.EAGER)
	@JoinColumn(name = "fid",referencedColumnName = "ID")
	public TScIcJhstockbillExcelEntity getEntryToMain() {
		return entryToMain;
	}

	public void setEntryToMain(TScIcJhstockbillExcelEntity entryToMain) {
