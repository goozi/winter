...
import com.qihang.buss.sc.baseinfo.entity.TScStockForIcitemEntity;
import com.qihang.buss.sc.baseinfo.entity.TScSupplierForIcitemEntity;
...
public class TScIcitemToOrderEntity implements java.io.Serializable {
	/**主键*/
	private String id;
	/**创建人名称*/
