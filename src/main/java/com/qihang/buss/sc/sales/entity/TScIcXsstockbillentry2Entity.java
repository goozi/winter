...
public class TScIcXsstockbillentry2Entity implements java.io.Serializable {
	/**主键*/
	...
	/**
	 *方法: 取得java.math.BigDecimal
	 *@return: java.math.BigDecimal  保质期
	 */
	@Column(name ="KFPERIOD",nullable=true,scale=10,length=20)
	public java.math.BigDecimal getKfPeriod(){
		return this.kfPeriod;
	}

	/**
	 *方法: 设置java.math.BigDecimal
	 *@param: java.math.BigDecimal  保质期
	 */
	public void setKfPeriod(java.math.BigDecimal kfPeriod){
