 ...
 */
@Entity
@Table(name = "v_sc_quote_select", schema = "")
public class TScQuoteViewSelectEntity implements java.io.Serializable {
	...
	private String icitemUnitName;

	private Double icitemCoefficient;

	private Double icitemxsLimitPrice;
	/**数量段(从)*/
	...
	@Column(name="icitemUnitName")
	public String getIcitemUnitName() {
		return icitemUnitName;
	}

	public void setIcitemUnitName(String icitemUnitName) {
		this.icitemUnitName = icitemUnitName;
	}

	@Column(name="icitemCoefficient")
	public Double getIcitemCoefficient() {
		return icitemCoefficient;
	}

	public void setIcitemCoefficient(Double icitemCoefficient) {
		this.icitemCoefficient = icitemCoefficient;
	}

	@Column(name="icitemxsLimitPrice")
	public Double getIcitemxsLimitPrice() {
		return icitemxsLimitPrice;
	}

	public void setIcitemxsLimitPrice(Double icitemxsLimitPrice) {
		this.icitemxsLimitPrice = icitemxsLimitPrice;
	}
