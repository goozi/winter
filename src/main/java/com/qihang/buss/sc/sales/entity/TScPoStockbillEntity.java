...
public class TScPoStockbillEntity implements java.io.Serializable {
	/**主键*/
  ...
  @Excel(name="分支机构")
	...
	//List<TScPoStockbillentryEntity> entityList;
	/**
	 * 版本号
	 */
...
//	public List<TScPoStockbillentryEntity> getEntityList() {
//		return entityList;
//	}
//
//	public void setEntityList(List<TScPoStockbillentryEntity> entityList) {
