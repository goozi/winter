...
public class TScIcJhstockbillentry1Entity implements java.io.Serializable {
	/**主键*/
	 ...
	 */
	@Column(name ="BILLNO_SRC",nullable=true,length=100)
	 ...
	 */
	@Column(name ="BILLNO_ORDER",nullable=true,length=100)
