...
public class TScSlStockBillentryExcelEntity implements java.io.Serializable {
	/**主键*/
	private String id;
	/**创建人名称*/
	...
	private TScSlStockBillExcelEntity entryToMain;

	@ManyToOne(fetch = FetchType.EAGER)
	@JoinColumn(name = "fid",referencedColumnName = "ID")
	public TScSlStockBillExcelEntity getEntryToMain() {
		return entryToMain;
	}

	public void setEntryToMain(TScSlStockBillExcelEntity entryToMain) {
